...
{
	public class KopalniaBrytanii : BaseRegion
	{
		public KopalniaBrytanii( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
		{
		}
     
                public override void OnEnter( Mobile from )
		{
		from.SendMessage( 0x35, "Wkroczy³eœ na teren Kopalni Brytanii!" );
                }

		public override void OnExit( Mobile from )
		{
		from.SendMessage( 0x35, "Opuœci³eœ Kopalnie Brytanii!" );
                }
