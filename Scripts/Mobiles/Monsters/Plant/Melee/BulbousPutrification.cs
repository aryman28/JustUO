...
namespace Server.Mobiles
{
    ...
    public class BulbousPutrification : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 104.8, 114.7);
            this.SetSkill(SkillName.Taktyka, 111.9, 119.1);
            this.SetSkill(SkillName.ObronaPrzedMagia, 55.5, 64.1);
            this.SetSkill(SkillName.Anatomia, 110.0);
            this.SetSkill(SkillName.Zatruwanie, 80.0);	
        }
