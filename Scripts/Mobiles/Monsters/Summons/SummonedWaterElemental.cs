...
namespace Server.Mobiles
{
    ...
    public class SummonedWaterElemental : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Medytacja, 90.0);
            this.SetSkill(SkillName.Intelekt, 80.0);
            this.SetSkill(SkillName.Magia, 80.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 75.0);
            this.SetSkill(SkillName.Taktyka, 100.0);
            this.SetSkill(SkillName.Boks, 85.0);
