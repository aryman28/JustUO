...
namespace Server.Mobiles
{
    ...
    public class MaddeningHorror : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 125.9);
            this.SetSkill(SkillName.Magia, 120.4);
            this.SetSkill(SkillName.Medytacja, 100.8);
            this.SetSkill(SkillName.ObronaPrzedMagia, 185.5);
            this.SetSkill(SkillName.Taktyka, 94.0);
            this.SetSkill(SkillName.Boks, 87.4);
        }
