...
namespace Server.Mobiles
{
	...
	public class Niporailem : BaseSABosses
	{
		...
		public Niporailem() : base( AIType.AI_NecroMage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.ObronaPrzedMagia, 87.7, 93.5 );
			SetSkill( SkillName.Taktyka, 56.1, 65.0 );
			SetSkill( SkillName.Boks, 68.8, 76.2 );
                        SetSkill( SkillName.Intelekt, 120.0 );
			SetSkill( SkillName.Magia, 120.0 );
			SetSkill( SkillName.Medytacja, 120.0 );
                        SetSkill( SkillName.Nekromancja, 120.0 );
                        SetSkill( SkillName.MowaDuchow, 120.0 );     
