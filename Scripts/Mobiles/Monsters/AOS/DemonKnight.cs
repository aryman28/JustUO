...
{
    [CorpseName("Zw³oki ojca ciemnoœci")]
    public class DemonKnight : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Nekromancja, 120, 120.0);
        ...
        public override void GenerateLoot()
        {
            ...
            this.AddLoot(LootPack.HighScrolls, Utility.RandomMinMax(2, 4));
        }
