...
namespace Server.Mobiles
{
    ...
    public class PixieRenowned : BaseRenowned
    {
            ...
            : base(AIType.AI_Mage)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 100.0, 100.0);
            this.SetSkill(SkillName.Magia, 90.1, 110.0);
            this.SetSkill(SkillName.Medytacja, 100.0, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 110.5, 150.0);
            this.SetSkill(SkillName.Taktyka, 100.1, 120.0);
