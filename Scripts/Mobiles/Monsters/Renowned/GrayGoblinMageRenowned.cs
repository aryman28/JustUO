...
namespace Server.Mobiles
{
    ...
    public class GrayGoblinMageRenowned : BaseRenowned
    {
            ...
            : base(AIType.AI_Mage)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 120.0, 125.0);
            this.SetSkill(SkillName.Taktyka, 95.0, 100.0);
            this.SetSkill(SkillName.Boks, 100.0, 110.0);
            this.SetSkill(SkillName.Intelekt, 100.0, 120.0);
            this.SetSkill(SkillName.Medytacja, 100.0, 105.0);
