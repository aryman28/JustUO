...
namespace Server.Mobiles
{
    ...
    public class FireDaemonRenowned : BaseRenowned
    {
            ...
            : base(AIType.AI_Mage)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 110.1, 132.6);
            this.SetSkill(SkillName.Taktyka, 86.9, 95.5);
            this.SetSkill(SkillName.Boks, 42.2, 98.8);
            this.SetSkill(SkillName.Magia, 97.1, 100.8);
            this.SetSkill(SkillName.Intelekt, 91.1, 91.8);
            this.SetSkill(SkillName.Medytacja, 45.4, 94.1);
            this.SetSkill(SkillName.Anatomia, 45.4, 74.1);
