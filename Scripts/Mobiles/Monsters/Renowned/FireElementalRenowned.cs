...
namespace Server.Mobiles
{
    ...
    public class FireElementalRenowned : BaseRenowned
    {
            ...
            : base(AIType.AI_Mage)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 100.1, 110.0);
            this.SetSkill(SkillName.Magia, 105.1, 110.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 110.2, 120.0);
            this.SetSkill(SkillName.Taktyka, 100.1, 105.0);
