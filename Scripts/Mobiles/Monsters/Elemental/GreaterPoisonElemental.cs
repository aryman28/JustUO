...
namespace Server.Mobiles
{
    ...
    public class GreaterPoisonElemental : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 80.1, 88.3);
            this.SetSkill(SkillName.Magia, 80.1, 97.0);
            this.SetSkill(SkillName.Medytacja, 80.2, 105.8);
            this.SetSkill(SkillName.Zatruwanie, 100.1, 114.9);
            this.SetSkill(SkillName.ObronaPrzedMagia, 85.2, 93.2);
            this.SetSkill(SkillName.Taktyka, 80.1, 87.3);
            this.SetSkill(SkillName.Boks, 80.1, 88.3);
