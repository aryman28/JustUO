...
namespace Server.Mobiles
{
    ...
    public class Mistral : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 96.2, 97.8);
            this.SetSkill(SkillName.Magia, 100.8, 112.9);
            this.SetSkill(SkillName.ObronaPrzedMagia, 106.2, 111.2);
            this.SetSkill(SkillName.Taktyka, 110.2, 117.1);
            this.SetSkill(SkillName.Boks, 100.3, 104.0);
