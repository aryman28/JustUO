...
namespace Server.Mobiles
{
    ...
    public class Tempest : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 99.6);
            this.SetSkill(SkillName.Magia, 101.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 104.6);
            this.SetSkill(SkillName.Taktyka, 111.8);
            this.SetSkill(SkillName.Boks, 116.0);
