...
namespace Server.Mobiles
{
    ...
    public class LavaElemental : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 0.0, 12.8);
            this.SetSkill(SkillName.Intelekt, 84.8, 92.6);
            this.SetSkill(SkillName.Magia, 90.1, 92.7);
            this.SetSkill(SkillName.Medytacja, 97.8, 102.8);
            this.SetSkill(SkillName.ObronaPrzedMagia, 101.9, 106.2);
            this.SetSkill(SkillName.Taktyka, 80.3, 94.0);
            this.SetSkill(SkillName.Boks, 71.7, 85.4);
