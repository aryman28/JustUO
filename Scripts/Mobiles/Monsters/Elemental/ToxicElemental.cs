...
namespace Server.Mobiles
{
    ...
    public class ToxicElemental : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 30.3, 60.0);
            this.SetSkill(SkillName.Intelekt, 70.1, 85.0);
            this.SetSkill(SkillName.Magia, 70.1, 85.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 60.1, 75.0);
