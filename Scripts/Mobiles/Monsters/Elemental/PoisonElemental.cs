...
namespace Server.Mobiles
{
    ...
    public class PoisonElemental : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 80.1, 95.0);
            this.SetSkill(SkillName.Magia, 80.1, 95.0);
            this.SetSkill(SkillName.Medytacja, 80.2, 120.0);
            this.SetSkill(SkillName.Zatruwanie, 90.1, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 85.2, 115.0);
            this.SetSkill(SkillName.Taktyka, 80.1, 100.0);
            this.SetSkill(SkillName.Boks, 70.1, 90.0);
