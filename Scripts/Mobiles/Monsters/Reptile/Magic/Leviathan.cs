...
namespace Server.Mobiles
{
    ...
    public class Leviathan : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 97.6, 107.5);
            this.SetSkill(SkillName.Magia, 97.6, 107.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 97.6, 107.5);
            this.SetSkill(SkillName.Medytacja, 97.6, 107.5);
            this.SetSkill(SkillName.Taktyka, 97.6, 107.5);
            this.SetSkill(SkillName.Boks, 97.6, 107.5);
