...
namespace Server.Mobiles
{
    ...
    public class Grim : Drake 
    {
            ...
            : base()
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 105.8, 115.6);
            this.SetSkill(SkillName.Taktyka, 102.8, 120.8);
            this.SetSkill(SkillName.Boks, 111.7, 119.2);
            this.SetSkill(SkillName.Anatomia, 105.0, 128.4);
