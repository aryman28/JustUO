...
namespace Server.Mobiles
{
    ...
    public class Coil : SilverSerpent
    {
            ...
            : base()
        {
            ...
            this.SetSkill(SkillName.Boks, 124.5, 134.5);
            this.SetSkill(SkillName.Taktyka, 130.2, 142.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 102.3, 113.0);
            this.SetSkill(SkillName.Anatomia, 120.8, 138.1);
            this.SetSkill(SkillName.Zatruwanie, 110.1, 133.4);
