...
namespace Server.Mobiles
{
    ...
    public class Abscess : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 132.3, 143.8);
            this.SetSkill(SkillName.Taktyka, 121.0, 130.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 102.9, 119.0);
            this.SetSkill(SkillName.Anatomia, 91.8, 94.3);
        }
