...
namespace Server.Mobiles
{
    ...
    public class Scorpion : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Zatruwanie, 80.1, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 30.1, 35.0);
            this.SetSkill(SkillName.Taktyka, 60.3, 75.0);
            this.SetSkill(SkillName.Boks, 50.3, 65.0);
