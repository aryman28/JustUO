...
namespace Server.Mobiles
{
    ...
    public class Mimic : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Magia, 107.5);
            this.SetSkill(SkillName.Medytacja, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 126.5);
            this.SetSkill(SkillName.Taktyka, 98.5);
            this.SetSkill(SkillName.Boks, 92.2);
