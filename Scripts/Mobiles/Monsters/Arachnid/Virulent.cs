...
namespace Server.Mobiles
{
    ...
    public class Virulent : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 92.8, 111.7);
            this.SetSkill(SkillName.Taktyka, 91.6, 107.4);
            this.SetSkill(SkillName.ObronaPrzedMagia, 78.1, 93.3);
            this.SetSkill(SkillName.Zatruwanie, 120.0);
            this.SetSkill(SkillName.Magia, 104.2, 119.8);
            this.SetSkill(SkillName.Intelekt, 102.8, 116.8);
