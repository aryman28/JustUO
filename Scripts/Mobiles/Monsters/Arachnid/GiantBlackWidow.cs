...
{
    [CorpseName("Zw³oki paj¹ka")] // stupid corpse name
    public class GiantBlackWidow : BaseCreature
    {
        ...
        {
            this.Name = "Olbrzymia czarna wdowa";
            this.Body = 0x9D;
            ...
            this.SetSkill(SkillName.Anatomia, 30.3, 75.0);
            this.SetSkill(SkillName.Zatruwanie, 60.1, 80.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 45.1, 60.0);
            this.SetSkill(SkillName.Taktyka, 65.1, 80.0);
            this.SetSkill(SkillName.Boks, 70.1, 85.0);
