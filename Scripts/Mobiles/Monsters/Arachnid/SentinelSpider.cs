...
namespace Server.Mobiles
{
    ...
    public class SentinelSpider : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 119.7);
            this.SetSkill(SkillName.Taktyka, 102.9);
            this.SetSkill(SkillName.ObronaPrzedMagia, 88.5);
            this.SetSkill(SkillName.Zatruwanie, 101.0);
