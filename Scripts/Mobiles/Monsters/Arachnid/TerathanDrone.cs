...
namespace Server.Mobiles
{
    ...
    public class TerathanDrone : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Zatruwanie, 40.1, 60.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 30.1, 45.0);
            this.SetSkill(SkillName.Taktyka, 30.1, 50.0);
