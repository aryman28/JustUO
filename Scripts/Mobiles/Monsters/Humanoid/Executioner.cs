...
{ 
    ...
    { 
        ...
        { 
            ...
            this.SetSkill(SkillName.WalkaSzpadami, 46.0, 77.5);
            this.SetSkill(SkillName.WalkaObuchami, 35.0, 57.5);
            this.SetSkill(SkillName.Zatruwanie, 60.0, 82.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 83.5, 92.5);
            this.SetSkill(SkillName.WalkaMieczami, 125.0);
            this.SetSkill(SkillName.Taktyka, 125.0);
            this.SetSkill(SkillName.Drwalnictwo, 125.0);
