...
namespace Server.Mobiles
{
    ...
    public class EnslavedGoblinScout : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 95.0, 95.0);
            this.SetSkill(SkillName.Taktyka, 80.0, 86.9);
            this.SetSkill(SkillName.Anatomia, 82.0, 89.3);
            this.SetSkill(SkillName.Boks, 99.2, 113.7);
