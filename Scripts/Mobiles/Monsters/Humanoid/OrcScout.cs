...
namespace Server.Mobiles
{
	...
	public class OrcScout : BaseCreature
	{
			...
			: base(AIType.AI_OrcScout, FightMode.Closest, 10, 7, 0.2, 0.4)
		{
			...
			SetSkill(SkillName.ObronaPrzedMagia, 50.1, 75.0);
			SetSkill(SkillName.Taktyka, 55.1, 80.0);

			SetSkill(SkillName.WalkaSzpadami, 50.1, 70.0);
			SetSkill(SkillName.Lucznictwo, 80.1, 120.0);
			SetSkill(SkillName.Parowanie, 40.1, 60.0);
			SetSkill(SkillName.Leczenie, 80.1, 100.0);
			SetSkill(SkillName.Anatomia, 50.1, 90.0);
			SetSkill(SkillName.Wykrywanie, 100.1, 120.0);
			SetSkill(SkillName.Ukrywanie, 100.0, 120.0);
			SetSkill(SkillName.Zakradanie, 80.1, 120.0);
