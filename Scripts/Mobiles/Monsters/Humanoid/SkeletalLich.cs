...
namespace Server.Mobiles
{
	...
	public class SkeletalLich : BaseCreature
	{
		...
		public SkeletalLich() : base( AIType.AI_Spellbinder, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Intelekt, 127.2 );
			SetSkill( SkillName.Magia, 127.2 );
			SetSkill( SkillName.Nekromancja, 100.0, 120.0 );
			SetSkill( SkillName.ObronaPrzedMagia, 187.1 );
			SetSkill( SkillName.Taktyka, 91.7 );
			SetSkill( SkillName.Boks, 98.5 );
