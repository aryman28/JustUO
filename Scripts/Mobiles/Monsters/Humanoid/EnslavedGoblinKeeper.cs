...
namespace Server.Mobiles
{
    ...
    public class EnslavedGoblinKeeper : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 121.6, 122.2);
            this.SetSkill(SkillName.Taktyka, 80.0, 82.8);
            this.SetSkill(SkillName.Anatomia, 82.0, 84.8);
            this.SetSkill(SkillName.Boks, 99.2, 100.7);
