...
{ 
    ...
    { 
        ...
        { 
            ...
            this.SetSkill(SkillName.Intelekt, 80.2, 100.0);
            this.SetSkill(SkillName.Magia, 95.1, 100.0);
            this.SetSkill(SkillName.Medytacja, 27.5, 50.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 77.5, 100.0);
            this.SetSkill(SkillName.Taktyka, 65.0, 87.5);
            this.SetSkill(SkillName.Boks, 20.3, 80.0);
