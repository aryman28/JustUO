...
namespace Server.Mobiles
{
    ...
    public class GreenGoblin : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 120.5, 128.8);
            this.SetSkill(SkillName.Taktyka, 80.9, 89.9);
            this.SetSkill(SkillName.Anatomia, 83.1, 89.6);
            this.SetSkill(SkillName.Boks, 93.0, 108.3);
