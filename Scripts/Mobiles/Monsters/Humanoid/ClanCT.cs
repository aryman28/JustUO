...
namespace Server.Mobiles
{
    ...
    public class ClanCT : BaseCreature
    {
            ...
            : base(AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 62.5, 82.6);
            this.SetSkill(SkillName.Lucznictwo, 80.1, 90.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 76.8, 99.3);
            this.SetSkill(SkillName.Taktyka, 64.2, 84.4);
            this.SetSkill(SkillName.Boks, 62.8, 85.0);
