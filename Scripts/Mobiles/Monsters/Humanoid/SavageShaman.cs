...
namespace Server.Mobiles
{
	...
	public class SavageShaman : BaseCreature
	{
			...
			: base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
		{
			...
			SetSkill(SkillName.Intelekt, 77.5, 100.0);
			SetSkill(SkillName.WalkaSzpadami, 62.5, 85.0);
			SetSkill(SkillName.WalkaObuchami, 62.5, 85.0);
			SetSkill(SkillName.Magia, 72.5, 95.0);
			SetSkill(SkillName.Medytacja, 77.5, 100.0);
			SetSkill(SkillName.ObronaPrzedMagia, 77.5, 100.0);
			SetSkill(SkillName.WalkaMieczami, 62.5, 85.0);
			SetSkill(SkillName.Taktyka, 62.5, 85.0);
			SetSkill(SkillName.Boks, 62.5, 85.0);
					...
					case 0: /* greater heal */
						{
							foreach (Mobile m in list)
							{
								...
								int toHeal = (int)(Skills[SkillName.Magia].Value * 0.4);
					...
					case 1: /* lightning */
						{
							foreach (Mobile m in list)
							{
								...
								if (Core.AOS)
								{
									int baseDamage = 6 + (int)(Skills[SkillName.Intelekt].Value / 5.0);
					...
					case 2: /* poison */
						{
							foreach (Mobile m in list)
							{
								...
								double total = Skills[SkillName.Magia].Value + Skills[SkillName.Zatruwanie].Value;
