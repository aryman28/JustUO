...
namespace Server.Mobiles
{
    ...
    public class RatmanArcher : BaseCreature
    {
            ...
            : base(AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 60.2, 100.0);
            this.SetSkill(SkillName.Lucznictwo, 80.1, 90.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 65.1, 90.0);
            this.SetSkill(SkillName.Taktyka, 50.1, 75.0);
            this.SetSkill(SkillName.Boks, 50.1, 75.0);
