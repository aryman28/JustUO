...
namespace Server.Mobiles
{
    ...
    public class Wight : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 40.0, 50.0);
            this.SetSkill(SkillName.Taktyka, 45.0, 55.0);
            this.SetSkill(SkillName.Boks, 50.0, 60.0);
            this.SetSkill(SkillName.Magia, 60.0, 80.0);
            this.SetSkill(SkillName.Medytacja, 50.0, 60.0);
