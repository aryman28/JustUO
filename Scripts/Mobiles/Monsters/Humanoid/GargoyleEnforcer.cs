...
namespace Server.Mobiles
{
    ...
    public class GargoyleEnforcer : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 120.1, 130.0);
            this.SetSkill(SkillName.Taktyka, 70.1, 80.0);
            this.SetSkill(SkillName.Boks, 80.1, 90.0);
            this.SetSkill(SkillName.WalkaMieczami, 80.1, 90.0);
            this.SetSkill(SkillName.Anatomia, 70.1, 80.0);
            this.SetSkill(SkillName.Magia, 80.1, 90.0);
            this.SetSkill(SkillName.Intelekt, 70.3, 100.0);
            this.SetSkill(SkillName.Medytacja, 70.3, 100.0);
