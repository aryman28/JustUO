...
namespace Server.Mobiles
{
    ...
    public class FireGargoyle : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 75.1, 85.0);
            this.SetSkill(SkillName.Intelekt, 90.1, 105.0);
            this.SetSkill(SkillName.Magia, 90.1, 105.0);
            this.SetSkill(SkillName.Medytacja, 90.1, 105.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 90.1, 105.0);
            this.SetSkill(SkillName.Taktyka, 80.1, 100.0);
            this.SetSkill(SkillName.Boks, 40.1, 80.0);
