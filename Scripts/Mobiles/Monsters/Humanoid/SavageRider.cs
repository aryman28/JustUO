...
namespace Server.Mobiles
{
    ...
    public class SavageRider : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.15, 0.4)
        {
            ...
            this.SetSkill(SkillName.WalkaSzpadami, 72.5, 95.0);
            this.SetSkill(SkillName.Leczenie, 60.3, 90.0);
            this.SetSkill(SkillName.WalkaObuchami, 72.5, 95.0);
            this.SetSkill(SkillName.Zatruwanie, 60.0, 82.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 72.5, 95.0);
            this.SetSkill(SkillName.WalkaMieczami, 72.5, 95.0);
            this.SetSkill(SkillName.Taktyka, 72.5, 95.0);
