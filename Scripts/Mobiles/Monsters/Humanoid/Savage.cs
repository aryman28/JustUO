...
namespace Server.Mobiles
{
    ...
    public class Savage : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.WalkaSzpadami, 60.0, 82.5);
            this.SetSkill(SkillName.WalkaObuchami, 60.0, 82.5);
            this.SetSkill(SkillName.Zatruwanie, 60.0, 82.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 57.5, 80.0);
            this.SetSkill(SkillName.WalkaMieczami, 60.0, 82.5);
            this.SetSkill(SkillName.Taktyka, 60.0, 82.5);
