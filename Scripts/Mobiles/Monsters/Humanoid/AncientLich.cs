...
namespace Server.Mobiles
{
    ...
    public class AncientLich : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 120.1, 130.0);
            this.SetSkill(SkillName.Magia, 120.1, 130.0);
            this.SetSkill(SkillName.Medytacja, 100.1, 101.0);
            this.SetSkill(SkillName.Zatruwanie, 100.1, 101.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 175.2, 200.0);
            this.SetSkill(SkillName.Taktyka, 90.1, 100.0);
            this.SetSkill(SkillName.Boks, 75.1, 100.0);
