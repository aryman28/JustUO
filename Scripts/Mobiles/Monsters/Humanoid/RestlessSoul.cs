...
namespace Server.Mobiles
{
    ...
    public class RestlessSoul : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 20.1, 30.0);
            this.SetSkill(SkillName.WalkaMieczami, 20.1, 30.0);
            this.SetSkill(SkillName.Taktyka, 20.1, 30.0);
            this.SetSkill(SkillName.Boks, 20.1, 30.0);
