...
namespace Server.Mobiles
{
    ...
    public class GreenGoblinAlchemist : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 120.3, 129.2);
            this.SetSkill(SkillName.Taktyka, 81.9, 87.1);
            this.SetSkill(SkillName.Anatomia, 0.0, 0.0);
            this.SetSkill(SkillName.Boks, 94.8, 106.9);
