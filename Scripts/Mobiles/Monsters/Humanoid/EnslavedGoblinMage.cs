...
namespace Server.Mobiles
{
    ...
    public class EnslavedGoblinMage : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 121.6, 149.7);
            this.SetSkill(SkillName.Taktyka, 80.0, 85.2);
            this.SetSkill(SkillName.Anatomia, 82.0, 86.6);
            this.SetSkill(SkillName.Boks, 99.2, 106.4);
