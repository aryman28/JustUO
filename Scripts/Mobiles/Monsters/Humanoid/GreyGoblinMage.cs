...
namespace Server.Mobiles
{
    ...
    public class GrayGoblinMage : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.ObronaPrzedMagia, 141.9, 147.1);
            SetSkill(SkillName.Taktyka, 80.7, 86.9);
            SetSkill(SkillName.Anatomia, 81.9, 89.4);
            SetSkill(SkillName.Boks, 90.5, 104.2);
            SetSkill(SkillName.Magia, 105.5, 119.1);
            SetSkill(SkillName.Intelekt, 94.9, 107.7);
