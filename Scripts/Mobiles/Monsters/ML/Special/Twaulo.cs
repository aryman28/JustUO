...
namespace Server.Mobiles
{
    ...
    public class Twaulo : BaseChampion
    {
            ...
            : base(AIType.AI_Melee)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 0); // Per Stratics?!?
            this.SetSkill(SkillName.Magia, 0); // Per Stratics?!?
            this.SetSkill(SkillName.Medytacja, 0); // Per Stratics?!?
            this.SetSkill(SkillName.Anatomia, 95.1, 115.0);
            this.SetSkill(SkillName.Lucznictwo, 95.1, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 50.3, 80.0);
            this.SetSkill(SkillName.Taktyka, 90.1, 100.0);
            this.SetSkill(SkillName.Boks, 95.1, 100.0);
