...
namespace Server.Mobiles
{
    ...
    public class Ilhenir : BaseChampion
    {
            ...
            : base(AIType.AI_Mage)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 100);
            this.SetSkill(SkillName.Magia, 100);
            this.SetSkill(SkillName.Medytacja, 0);
            this.SetSkill(SkillName.Zatruwanie, 5.4);
            this.SetSkill(SkillName.Anatomia, 117.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 120.0);
            this.SetSkill(SkillName.Taktyka, 119.9);
            this.SetSkill(SkillName.Boks, 119.9);
