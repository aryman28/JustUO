...
namespace Server.Mobiles
{
    ...
    public class Meraktus : BaseChampion
    {
            ...
            : base(AIType.AI_Melee)
        {
            ...
            //SetSkill( SkillName.Medytacja, Unknown );
            //SetSkill( SkillName.Intelekt, Unknown );
            //SetSkill( SkillName.Magia, Unknown );
            //SetSkill( SkillName.Zatruwanie, Unknown );
            this.SetSkill(SkillName.Anatomia, 0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 107.0, 111.3);
            this.SetSkill(SkillName.Taktyka, 107.0, 117.0);
            this.SetSkill(SkillName.Boks, 100.0, 105.0);
