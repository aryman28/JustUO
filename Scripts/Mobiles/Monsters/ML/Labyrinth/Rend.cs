...
namespace Server.Mobiles
{
    ...
    public class Rend : Reptalon
    {
        ...
        public Rend()
        {
            ...
            this.SetSkill(SkillName.Boks, 136.3, 150.3);
            this.SetSkill(SkillName.Taktyka, 133.4, 141.4);
            this.SetSkill(SkillName.ObronaPrzedMagia, 90.9, 110.0);
            this.SetSkill(SkillName.Anatomia, 66.6, 72.0);
