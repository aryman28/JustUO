...
namespace Server.Mobiles
{
    ...
    public class Pyre : Phoenix
    {
        ...
        public Pyre()
        {
            ...
            this.SetSkill(SkillName.Boks, 121.9, 130.6);
            this.SetSkill(SkillName.Taktyka, 114.4, 117.4);
            this.SetSkill(SkillName.ObronaPrzedMagia, 147.7, 153.0);
            this.SetSkill(SkillName.Zatruwanie, 122.8, 124.0);
            this.SetSkill(SkillName.Magia, 121.8, 127.8);
            this.SetSkill(SkillName.Intelekt, 103.6, 117.0);
