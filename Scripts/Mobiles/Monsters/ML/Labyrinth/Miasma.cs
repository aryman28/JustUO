...
namespace Server.Mobiles
{
    ...
    public class Miasma : Scorpion
    {
        ...
        public Miasma()
        {
            ...
            this.SetSkill(SkillName.Boks, 64.9, 73.3);
            this.SetSkill(SkillName.Taktyka, 98.4, 110.6);
            this.SetSkill(SkillName.ObronaPrzedMagia, 74.4, 77.7);
            this.SetSkill(SkillName.Zatruwanie, 128.5, 143.6);
