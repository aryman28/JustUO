...
namespace Server.Mobiles
{
    ...
    public class LadyJennifyr : SkeletalKnight
    {
        ...
        public LadyJennifyr()
        {
            ...
            this.SetSkill(SkillName.Boks, 127.9, 137.1);
            this.SetSkill(SkillName.Taktyka, 128.4, 141.9);
            this.SetSkill(SkillName.ObronaPrzedMagia, 102.1, 119.5);
            this.SetSkill(SkillName.Anatomia, 129.0, 137.5);
