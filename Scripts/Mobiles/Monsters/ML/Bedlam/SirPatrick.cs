...
namespace Server.Mobiles
{
    ...
    public class SirPatrick : SkeletalKnight
    {
        ...
        public SirPatrick()
        {
            ...
            this.SetSkill(SkillName.Boks, 126.3, 136.5);
            this.SetSkill(SkillName.Taktyka, 128.5, 143.8);
            this.SetSkill(SkillName.ObronaPrzedMagia, 102.8, 117.9);
            this.SetSkill(SkillName.Anatomia, 127.5, 137.2);
