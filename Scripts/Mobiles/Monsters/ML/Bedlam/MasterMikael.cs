...
namespace Server.Mobiles
{
    ...
    public class MasterMikael : BoneMagi
    {
        ...
        public MasterMikael()
        {
            ...
            this.SetSkill(SkillName.Boks, 80.1, 87.2);
            this.SetSkill(SkillName.Taktyka, 79.0, 90.9);
            this.SetSkill(SkillName.ObronaPrzedMagia, 90.3, 106.9);
            this.SetSkill(SkillName.Magia, 103.8, 108.0);
            this.SetSkill(SkillName.Intelekt, 96.1, 105.3);
            this.SetSkill(SkillName.Nekromancja, 103.8, 108.0);
            this.SetSkill(SkillName.MowaDuchow, 96.1, 105.3);
