...
namespace Server.Mobiles
{
    ...
    public class LadyMarai : SkeletalKnight
    {
        ...
        public LadyMarai()
        {
            ...
            this.SetSkill(SkillName.Boks, 126.6, 137.2);
            this.SetSkill(SkillName.Taktyka, 128.7, 134.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 102.1, 119.1);
            this.SetSkill(SkillName.Anatomia, 126.2, 136.5);
