...
namespace Server.Mobiles
{
    ...
    public class Putrefier : Balron
    {
        ...
        public Putrefier()
        {
            ...
            this.SetSkill(SkillName.Boks, 111.2, 128.0);
            this.SetSkill(SkillName.Taktyka, 115.2, 125.2);
            this.SetSkill(SkillName.ObronaPrzedMagia, 143.4, 170.0);
            this.SetSkill(SkillName.Anatomia, 44.6, 67.0);
            this.SetSkill(SkillName.Magia, 117.6, 118.8);
            this.SetSkill(SkillName.Intelekt, 113.0, 128.8);
            this.SetSkill(SkillName.Medytacja, 41.4, 85.0);
            this.SetSkill(SkillName.Zatruwanie, 45.0, 50.0);
