...
namespace Server.Mobiles
{
    ...
    public class UnfrozenMummy : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.4, 0.8)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 250.0);
            this.SetSkill(SkillName.Magia, 50.0, 60.0);
            this.SetSkill(SkillName.Intelekt, 50.0, 60.0);
            this.SetSkill(SkillName.Medytacja, 80.0);
