...
namespace Server.Mobiles
{
    ...
    public class CorrosiveSlime : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Zatruwanie, 36.0, 49.1);
            this.SetSkill(SkillName.Anatomia, 0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 15.9, 18.9);
            this.SetSkill(SkillName.Taktyka, 24.6, 26.1);
            this.SetSkill(SkillName.Boks, 24.9, 26.1);
