...
namespace Server.Mobiles
{
    ...
    public class Reptalon : BaseMount
    {
            ...
            : base("a reptalon", 0x114, 0x3E90, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.35)
        {
            ...
            this.SetSkill(SkillName.Boks, 101.5, 118.2);
            this.SetSkill(SkillName.Taktyka, 101.7, 108.2);
            this.SetSkill(SkillName.ObronaPrzedMagia, 76.4, 89.9);
            this.SetSkill(SkillName.Anatomia, 56.4, 59.7);
