...
namespace Server.Mobiles
{
    ...
    public class Szavetra : Succubus
    {
        ...
        public Szavetra()
        {
            ...
            this.SetSkill(SkillName.Intelekt, 90.3, 99.8);
            this.SetSkill(SkillName.Magia, 100.1, 100.6); // 10.1-10.6 on OSI, bug?
            this.SetSkill(SkillName.Medytacja, 90.1, 110.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 112.2, 127.2);
            this.SetSkill(SkillName.Taktyka, 91.2, 92.8);
            this.SetSkill(SkillName.Boks, 80.2, 86.4);
