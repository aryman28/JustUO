...
namespace Server.Mobiles
{
    ...
    public class Spite : Changeling
    {
        ...
        public Spite()
        {
            ...
            this.SetSkill(SkillName.Boks, 12.8, 16.7);
            this.SetSkill(SkillName.Taktyka, 102.6, 131.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 141.2, 161.6);
            this.SetSkill(SkillName.Magia, 108.4, 119.2);
            this.SetSkill(SkillName.Intelekt, 108.4, 120.0);
            this.SetSkill(SkillName.Medytacja, 109.2, 120.0);
