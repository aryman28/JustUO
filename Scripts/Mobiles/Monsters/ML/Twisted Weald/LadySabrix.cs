...
namespace Server.Mobiles
{
    ...
    public class LadySabrix : GiantBlackWidow
    {
        ...
        public LadySabrix()
        {
            ...
            this.SetSkill(SkillName.Boks, 109.8, 122.8);
            this.SetSkill(SkillName.Taktyka, 102.8, 120.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 79.4, 95.1);
            this.SetSkill(SkillName.Anatomia, 68.8, 105.1);
            this.SetSkill(SkillName.Zatruwanie, 97.8, 116.7);
