...
namespace Server.Mobiles
{
    ...
    public class LadyLissith : GiantBlackWidow
    {
        ...
        public LadyLissith()
        {
            ...
            this.SetSkill(SkillName.Boks, 108.6, 123.0);
            this.SetSkill(SkillName.Taktyka, 102.7, 119.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 78.8, 95.6);
            this.SetSkill(SkillName.Anatomia, 68.6, 106.8);
            this.SetSkill(SkillName.Zatruwanie, 96.6, 112.9);
