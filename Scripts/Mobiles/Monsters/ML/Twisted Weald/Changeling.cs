...
namespace Server.Mobiles
{
    ...
    public class Changeling : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 10.4, 12.5);
            this.SetSkill(SkillName.Taktyka, 101.1, 108.3);
            this.SetSkill(SkillName.ObronaPrzedMagia, 121.6, 132.2);
            this.SetSkill(SkillName.Magia, 91.6, 99.5);
            this.SetSkill(SkillName.Intelekt, 91.5, 98.8);
            this.SetSkill(SkillName.Medytacja, 91.7, 98.5);
