...
namespace Server.Mobiles
{
    ...
    public class Irk : Changeling
    {
        ...
        public Irk()
        {
            ...
            this.SetSkill(SkillName.Boks, 120.3, 123.0);
            this.SetSkill(SkillName.Taktyka, 120.1, 131.8);
            this.SetSkill(SkillName.ObronaPrzedMagia, 132.3, 165.8);
            this.SetSkill(SkillName.Magia, 108.9, 119.7);
            this.SetSkill(SkillName.Intelekt, 108.4, 120.0);
            this.SetSkill(SkillName.Medytacja, 108.9, 119.1);
