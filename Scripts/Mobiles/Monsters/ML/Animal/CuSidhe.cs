...
namespace Server.Mobiles
{
    ...
    public class CuSidhe : BaseMount
    {
            ...
            : base(name, 277, 0x3E91, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 90.1, 96.8);
            this.SetSkill(SkillName.Taktyka, 90.3, 99.3);
            this.SetSkill(SkillName.ObronaPrzedMagia, 75.3, 90.0);
            this.SetSkill(SkillName.Anatomia, 65.5, 69.4);
            this.SetSkill(SkillName.Leczenie, 72.2, 98.9);
