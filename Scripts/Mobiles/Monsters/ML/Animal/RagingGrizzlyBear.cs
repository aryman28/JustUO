...
namespace Server.Mobiles
{
    ...
    public class RagingGrizzlyBear : BaseCreature
    {
            ...
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 73.4, 88.1);
            this.SetSkill(SkillName.Taktyka, 73.6, 110.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 32.8, 54.6);
            this.SetSkill(SkillName.Anatomia, 0, 0);
