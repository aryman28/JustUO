...
namespace Server.Mobiles
{
    ...
    public class InterredGrizzle : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Medytacja, 77.7, 84.0);
            this.SetSkill(SkillName.Intelekt, 72.2, 79.6);
            this.SetSkill(SkillName.Magia, 83.7, 89.6);
            this.SetSkill(SkillName.Zatruwanie, 0);
            this.SetSkill(SkillName.Anatomia, 0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 80.2, 87.3);
            this.SetSkill(SkillName.Taktyka, 104.5, 105.1);
            this.SetSkill(SkillName.Boks, 105.1, 109.4);
