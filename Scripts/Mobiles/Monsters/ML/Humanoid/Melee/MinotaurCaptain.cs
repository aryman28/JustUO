...
namespace Server.Mobiles
{
    ...
    public class MinotaurCaptain : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)// NEED TO CHECK
        {
            ...
            this.SetSkill(SkillName.Intelekt, 0);
            this.SetSkill(SkillName.Magia, 0);
            this.SetSkill(SkillName.Zatruwanie, 0);
            this.SetSkill(SkillName.Anatomia, 0, 6.3);
            this.SetSkill(SkillName.ObronaPrzedMagia, 66.1, 73.6);
            this.SetSkill(SkillName.Taktyka, 93.0, 109.9);
            this.SetSkill(SkillName.Boks, 92.6, 107.2);
