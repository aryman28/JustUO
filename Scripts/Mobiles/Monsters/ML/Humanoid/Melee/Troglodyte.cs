...
namespace Server.Mobiles
{
    ...
    public class Troglodyte : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)// NEED TO CHECK
        {
            ...
            this.SetSkill(SkillName.Anatomia, 70.5, 94.8);
            this.SetSkill(SkillName.ObronaPrzedMagia, 51.8, 65.0);
            this.SetSkill(SkillName.Taktyka, 80.4, 94.7);
            this.SetSkill(SkillName.Boks, 70.2, 93.5);
            this.SetSkill(SkillName.Leczenie, 70.0, 95.0);
