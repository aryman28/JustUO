...
namespace Server.Mobiles
{
    ...
    public class MLDryad : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Medytacja, 80.0, 90.0);
            this.SetSkill(SkillName.Intelekt, 70.0, 80.0);
            this.SetSkill(SkillName.Magia, 70.0, 80.0);
            this.SetSkill(SkillName.Anatomia, 0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 100.0, 120.0);
            this.SetSkill(SkillName.Taktyka, 70.0, 80.0);
            this.SetSkill(SkillName.Boks, 70.0, 80.0);
