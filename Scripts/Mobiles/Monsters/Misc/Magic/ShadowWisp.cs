...
namespace Server.Mobiles
{
    ...
    public class ShadowWisp : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.3, 0.6)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 40.0);
            this.SetSkill(SkillName.Magia, 50.0);
            this.SetSkill(SkillName.Medytacja, 40.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 10.0);
            this.SetSkill(SkillName.Taktyka, 0.1, 15.0);
            this.SetSkill(SkillName.Boks, 25.1, 40.0);
