...
namespace Server.Mobiles
{
    ...
    public class Golem : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, (150.1 * scalar), (190.0 * scalar));
            this.SetSkill(SkillName.Taktyka, (60.1 * scalar), (100.0 * scalar));
            this.SetSkill(SkillName.Boks, (60.1 * scalar), (100.0 * scalar));
