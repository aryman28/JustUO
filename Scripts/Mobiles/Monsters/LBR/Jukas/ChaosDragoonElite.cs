...
namespace Server.Mobiles
{
    ...
    public class ChaosDragoonElite : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 100.1, 110.0);
            this.SetSkill(SkillName.Anatomia, 80.1, 100.0);
            this.SetSkill(SkillName.Magia, 85.1, 100.0);
            this.SetSkill(SkillName.Intelekt, 85.1, 100.0);
            this.SetSkill(SkillName.WalkaMieczami, 72.5, 95.0);
            this.SetSkill(SkillName.WalkaSzpadami, 85.1, 100);
            this.SetSkill(SkillName.WalkaObuchami, 85.1, 100);
