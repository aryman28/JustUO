...
namespace Server.Mobiles
{
    ...
    public class ChaosDragoon : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.15, 0.4)
        {
            ...
            this.SetSkill(SkillName.WalkaSzpadami, 77.6, 92.5);
            this.SetSkill(SkillName.Leczenie, 60.3, 90.0);
            this.SetSkill(SkillName.WalkaObuchami, 77.6, 92.5);
            this.SetSkill(SkillName.Anatomia, 77.6, 87.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 77.6, 97.5);
            this.SetSkill(SkillName.WalkaMieczami, 77.6, 92.5);
            this.SetSkill(SkillName.Taktyka, 77.6, 87.5);
