...
namespace Server.Mobiles
{
    ...
    public class MeerCaptain : BaseCreature
    {
            ...
            : base(AIType.AI_Archer, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Lucznictwo, 90.1, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 91.0, 100.0);
            this.SetSkill(SkillName.WalkaMieczami, 90.1, 100.0);
            this.SetSkill(SkillName.Taktyka, 91.0, 100.0);
            this.SetSkill(SkillName.Boks, 80.9, 89.9);
