...
namespace Server.Mobiles
{
    ...
    public class YomotsuPriest : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 92.6, 107.5);
            this.SetSkill(SkillName.Magia, 105.1, 115.0);
            this.SetSkill(SkillName.Medytacja, 100.1, 110.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 112.6, 122.5);
            this.SetSkill(SkillName.Taktyka, 55.1, 105.0);
            this.SetSkill(SkillName.Boks, 47.6, 57.5);
