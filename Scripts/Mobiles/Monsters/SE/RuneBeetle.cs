...
namespace Server.Mobiles
{
    ...
    public class RuneBeetle : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 100.1, 125.0);
            this.SetSkill(SkillName.Magia, 100.1, 110.0);
            this.SetSkill(SkillName.Zatruwanie, 120.1, 140.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 95.1, 110.0);
            this.SetSkill(SkillName.Taktyka, 78.1, 93.0);
            this.SetSkill(SkillName.Boks, 70.1, 77.5);
