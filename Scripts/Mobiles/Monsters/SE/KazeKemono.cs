...
namespace Server.Mobiles
{
    ...
    public class KazeKemono : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 110.1, 125.0);
            this.SetSkill(SkillName.Taktyka, 55.1, 65.0);
            this.SetSkill(SkillName.Boks, 85.1, 95.0);
            this.SetSkill(SkillName.Anatomia, 25.1, 35.0);
            this.SetSkill(SkillName.Magia, 95.1, 105.0);
