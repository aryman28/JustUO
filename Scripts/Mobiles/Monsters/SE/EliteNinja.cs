...
namespace Server.Mobiles
{
    public class EliteNinja : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.WalkaSzpadami, 95.0, 120.0);
            this.SetSkill(SkillName.WalkaObuchami, 95.0, 120.0);
            this.SetSkill(SkillName.WalkaMieczami, 95.0, 120.0);
            this.SetSkill(SkillName.Skrytobojstwo, 95.0, 120.0);
            ...
            Hides
            Stealths
            Can use Skrytobojstwo Abilities
