...
namespace Server.Mobiles
{
    ...
    public class DeathwatchBeetleHatchling : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, Core.ML ? FightMode.Aggressor : FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 30.1, 40.0);
            this.SetSkill(SkillName.Taktyka, 47.1, 57.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 30.1, 38.0);
            this.SetSkill(SkillName.Anatomia, 20.1, 24.0);
