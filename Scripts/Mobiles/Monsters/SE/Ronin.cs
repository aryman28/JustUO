...
namespace Server.Mobiles
{
    ...
    public class Ronin : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 42.6, 57.5);
            this.SetSkill(SkillName.Taktyka, 115.1, 130.0);
            this.SetSkill(SkillName.Boks, 92.6, 107.5);
            this.SetSkill(SkillName.Anatomia, 110.1, 125.0);

            this.SetSkill(SkillName.WalkaSzpadami, 92.6, 107.5);
            this.SetSkill(SkillName.WalkaObuchami, 92.6, 107.5);
            this.SetSkill(SkillName.WalkaMieczami, 92.6, 107.5);
