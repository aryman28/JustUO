...
namespace Server.Mobiles
{
    ...
    public class IronBeetle : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)// AI Type??
        {
            ...
            this.SetSkill(SkillName.Anatomia, 80.6, 89.5);
            this.SetSkill(SkillName.ObronaPrzedMagia, 123.2, 129.4);
            this.SetSkill(SkillName.Taktyka, 83.4, 96.4);
            this.SetSkill(SkillName.Boks, 94.0, 107.1);
