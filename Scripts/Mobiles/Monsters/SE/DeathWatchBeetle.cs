...
namespace Server.Mobiles
{
    ...
    public class DeathwatchBeetle : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, Core.ML ? FightMode.Aggressor : FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 50.1, 58.0);
            this.SetSkill(SkillName.Taktyka, 67.1, 77.0);
            this.SetSkill(SkillName.Boks, 50.1, 60.0);
            this.SetSkill(SkillName.Anatomia, 30.1, 34.0);
