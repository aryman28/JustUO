...
namespace Server.Mobiles
{
    ...
    public class MantraEffervescence : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 80.0, 85.0);
            this.SetSkill(SkillName.Taktyka, 80.0, 85.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 105.0, 115.0);
            this.SetSkill(SkillName.Magia, 90.0, 110.0);
            this.SetSkill(SkillName.Intelekt, 80.0, 90.0);
            this.SetSkill(SkillName.Medytacja, 90.0, 100.0);
