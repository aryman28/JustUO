...
namespace Server.Mobiles
{
    ...
    public class FeralTreefellow : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 40.1, 55.0);// Unknown
            this.SetSkill(SkillName.Taktyka, 65.1, 90.0);// Unknown
            this.SetSkill(SkillName.Boks, 65.1, 85.0);// Unknown
