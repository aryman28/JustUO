...
namespace Server.Mobiles
{
    ...
    public class Vasanord : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.6, 1.2)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 72.8, 77.7);
            this.SetSkill(SkillName.Taktyka, 50.7, 99.6);
            this.SetSkill(SkillName.Anatomia, 6.5, 17.1);
            this.SetSkill(SkillName.Intelekt, 92.5, 106.2);
            this.SetSkill(SkillName.Magia, 95.5, 106.9);
            this.SetSkill(SkillName.Boks, 93.6, 98.6);
