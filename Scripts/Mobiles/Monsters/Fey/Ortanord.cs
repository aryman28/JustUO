...
namespace Server.Mobiles
{
    ...
    public class Ortanord : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.6, 1.2)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 104.4, 108.0);
            this.SetSkill(SkillName.Taktyka, 19.0, 19.8);
            this.SetSkill(SkillName.Anatomia, 15.6, 16.8);
            this.SetSkill(SkillName.Boks, 15.4, 16.6);
            this.SetSkill(SkillName.Magia, 104.7, 107.3);
            this.SetSkill(SkillName.Medytacja, 20.0, 20.0);
