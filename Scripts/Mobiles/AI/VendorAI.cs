...
namespace Server.Mobiles
{
	public class VendorAI : BaseAI
	{
		...
		public override bool DoActionWander()
		{
			...
			{
				if ( m_Mobile.Debug )
					m_Mobile.DebugSay( "{0} atakuje mnie!", m_Mobile.Combatant.Name );
			...
			else
			{
				...
				{
					if ( m_Mobile.Debug )
						m_Mobile.DebugSay( "{0} mówi do mnie", m_Mobile.FocusMob.Name );
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			{
				if ( Regex.IsMatch( e.Speech, "sprzedac", RegexOptions.IgnoreCase) || e.HasKeyword( 0x14D ) ) // *vendor sell*
				{
					e.Handled = true;
				...
				else if ( Regex.IsMatch( e.Speech, "kupic", RegexOptions.IgnoreCase) || e.HasKeyword( 0x3C ) )
				{
					e.Handled = true;
