...
namespace Server.Mobiles
{
    ...
    public class Jwilson : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.Skills[SkillName.Boks].Base = Utility.Random(24, 17);
            this.Skills[SkillName.Taktyka].Base = Utility.Random(18, 14);
            this.Skills[SkillName.ObronaPrzedMagia].Base = Utility.Random(15, 6);
            this.Skills[SkillName.Zatruwanie].Base = Utility.Random(31, 20);
