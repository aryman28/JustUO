...
namespace Server.Mobiles
{
    ...
    public class ClanSH : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 35.4, 40.0);
            this.SetSkill(SkillName.Taktyka, 61.1, 65.0);
            this.SetSkill(SkillName.Boks, 64.0, 65.0);
            this.SetSkill(SkillName.Anatomia, 74.0, 75.0);
