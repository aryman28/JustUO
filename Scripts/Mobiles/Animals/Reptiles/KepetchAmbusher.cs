...
namespace Server.Mobiles
{
    ...
    public class KepetchAmbusher : BaseCreature
    {
            ...
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.Anatomia, 110.2, 112.4);
            SetSkill(SkillName.ObronaPrzedMagia, 95.8, 97.5);
            SetSkill(SkillName.Taktyka, 107.9, 112.4);
            SetSkill(SkillName.Boks, 103.7, 109.3);
