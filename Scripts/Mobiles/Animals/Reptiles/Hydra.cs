...
namespace Server.Mobiles
{
    ...
    public class Hydra : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Boks, 103.5, 117.4);
            this.SetSkill(SkillName.Taktyka, 100.1, 109.8);
            this.SetSkill(SkillName.ObronaPrzedMagia, 85.5, 96.4);
            this.SetSkill(SkillName.Anatomia, 75.4, 79.8);
