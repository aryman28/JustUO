...
namespace Server.Mobiles
{
    ...
    public class Yamandon : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 115.1, 130.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 117.6, 132.5);
            this.SetSkill(SkillName.Zatruwanie, 120.1, 140.0);
            this.SetSkill(SkillName.Taktyka, 117.1, 132.0);
            this.SetSkill(SkillName.Boks, 112.6, 132.5);
