...
namespace Server.Mobiles
{
    ...
    public class Kepetch : BaseCreature, ICarvable
    {
            ...
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 119.7, 124.1);
            this.SetSkill(SkillName.ObronaPrzedMagia, 89.9, 97.4);
            this.SetSkill(SkillName.Taktyka, 117.4, 123.5);
            this.SetSkill(SkillName.Boks, 107.7, 113.9);
        }
