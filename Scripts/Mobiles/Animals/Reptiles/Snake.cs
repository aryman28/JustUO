...
namespace Server.Mobiles
{
    ...
    public class Snake : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Zatruwanie, 50.1, 70.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 15.1, 20.0);
            this.SetSkill(SkillName.Taktyka, 19.3, 34.0);
            this.SetSkill(SkillName.Boks, 19.3, 34.0);
