...
namespace Server.Mobiles
{
    ...
    public class LesserHiryu : BaseMount
    {
            ...
            : base("a lesser hiryu", 243, 0x3E94, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 75.1, 80.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 85.1, 100.0);
            this.SetSkill(SkillName.Taktyka, 100.1, 110.0);
            this.SetSkill(SkillName.Boks, 100.1, 120.0);
        ...
        {
            if (this.ControlMaster.Skills[SkillName.Fanatyzm].Base >= 90.0)
                return true;
            return false;
        }
