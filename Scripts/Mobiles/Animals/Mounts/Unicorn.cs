...
namespace Server.Mobiles
{
    ...
    public class Unicorn : BaseMount
    {
            ...
            : base(name, 0x7A, 0x3EB4, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Magia, 60.2, 80.0);
            this.SetSkill(SkillName.Medytacja, 50.1, 60.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 75.3, 90.0);
            this.SetSkill(SkillName.Taktyka, 20.1, 22.5);
            this.SetSkill(SkillName.Boks, 80.5, 92.5);
        ...
        public override bool DoMountAbility(int damage, Mobile attacker)
        {
            ...
            if (this.Rider.Poisoned && ((this.Rider.Hits - damage) < 40))
            {
                ...
                if (p != null)
                {
                    int chanceToCure = 10000 + (int)(this.Skills[SkillName.Magia].Value * 75) - ((p.Level + 1) * (Core.AOS ? (p.Level < 4 ? 3300 : 3100) : 1750));
                    chanceToCure /= 100;
