...
namespace Server.Mobiles
{
	...
	public class Nightmare : BaseMount
	{
		...
		[Constructable]
		public Nightmare( string name ) : base( name, 0xB2, 0x3F11, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Intelekt, 10.4, 50.0 );
			SetSkill( SkillName.Magia, 10.4, 50.0 );
			SetSkill( SkillName.ObronaPrzedMagia, 85.3, 100.0 );
			SetSkill( SkillName.Taktyka, 97.6, 100.0 );
			SetSkill( SkillName.Boks, 80.5, 92.5 );
