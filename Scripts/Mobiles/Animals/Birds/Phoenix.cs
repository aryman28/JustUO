...
namespace Server.Mobiles
{
    ...
    public class Phoenix : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Intelekt, 90.2, 100.0);
            this.SetSkill(SkillName.Magia, 90.2, 100.0);
            this.SetSkill(SkillName.Medytacja, 75.1, 100.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 86.0, 135.0);
