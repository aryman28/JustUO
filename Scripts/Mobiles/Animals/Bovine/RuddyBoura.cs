...
namespace Server.Mobiles
{
    ...
    public class RuddyBoura : BaseCreature
    {
            ...
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 81.6, 88.2);
            this.SetSkill(SkillName.ObronaPrzedMagia, 66.5, 73.9);
            this.SetSkill(SkillName.Taktyka, 81.3, 88.8);
            this.SetSkill(SkillName.Boks, 83.6, 94.5);
