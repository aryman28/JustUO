...
namespace Server.Mobiles
{
    ...
    public class HighPlainsBoura : BaseCreature
    {
            ...
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.Anatomia, 96.5, 104.0);
            this.SetSkill(SkillName.ObronaPrzedMagia, 67.1, 74.5);
            this.SetSkill(SkillName.Taktyka, 95.8, 102.6);
            this.SetSkill(SkillName.Boks, 100.5, 111.4);
