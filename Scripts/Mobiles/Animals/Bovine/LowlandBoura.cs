...
namespace Server.Mobiles
{
    ...
    public class LowlandBoura : BaseCreature
    {
            ...
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.Anatomia, 80.3, 88.5);
            SetSkill(SkillName.ObronaPrzedMagia, 69.0, 79.6);
            SetSkill(SkillName.Taktyka, 78.8, 86.9);
            SetSkill(SkillName.Boks, 86.8, 98.6);
