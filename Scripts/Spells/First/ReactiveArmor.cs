        ...
        public override void OnCast()
        {
                ...
                */
                if (this.CheckSequence())
                {
                    ...
                    if (mods == null)
                    {
                        ...
                        {
                            new ResistanceMod(ResistanceType.Physical, 15 + (int)(targ.Skills[SkillName.Inskrypcja].Value / 20)),
                        ...
                        int physresist = 15 + (int)(targ.Skills[SkillName.Inskrypcja].Value / 20);
            ...
            else
            {
                ...
                else if (this.CheckSequence())
                {
                    ...
                    {
                        int value = (int)(this.Caster.Skills[SkillName.Magia].Value + this.Caster.Skills[SkillName.Medytacja].Value + this.Caster.Skills[SkillName.Inskrypcja].Value);
                        value /= 3;
