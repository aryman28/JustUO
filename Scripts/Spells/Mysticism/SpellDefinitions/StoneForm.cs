...
namespace Server.Spells.Mystic
{
    ...
    { 
        ...
        public override void OnCast()
        {
            ...
            {
                // Values
                int bonus1 = 2 + (int)(this.Caster.Skills[SkillName.Mistycyzm].Value / 20);
                int bonus = 1 + (int)(this.Caster.Skills[SkillName.Logistyka].Value / 20);

                double span = 7.0 + (this.Caster.Skills[SkillName.Mistycyzm].Value * 0.4);
                ...
                // Skill
                this.Caster.AddSkillMod(new TimedSkillMod(SkillName.ObronaPrzedMagia, true, -40, DateTime.UtcNow + TimeSpan.FromSeconds(span)));
