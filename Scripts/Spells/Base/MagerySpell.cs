...
namespace Server.Spells
{
    public abstract class MagerySpell : Spell
    {
        ...
        public override double GetResistSkill(Mobile m)
        {
            ...
            if (m.Skills[SkillName.ObronaPrzedMagia].Value < maxSkill)
                m.CheckSkill(SkillName.ObronaPrzedMagia, 0.0, m.Skills[SkillName.ObronaPrzedMagia].Cap);
        ...
        public virtual bool CheckResisted(Mobile target)
        {
            ...
            if (target.Skills[SkillName.ObronaPrzedMagia].Value < maxSkill)
                target.CheckSkill(SkillName.ObronaPrzedMagia, 0.0, target.Skills[SkillName.ObronaPrzedMagia].Cap);
        ...
        public virtual double GetResistPercentForCircle(Mobile target, SpellCircle circle)
        {
            ...
            double secondPercent = target.Skills[SkillName.ObronaPrzedMagia].Value - (((this.Caster.Skills[this.CastSkill].Value - 20.0) / 5.0) + (1 + (int)circle) * 5.0);
