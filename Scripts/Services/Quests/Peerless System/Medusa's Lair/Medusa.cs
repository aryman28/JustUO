...
namespace Server.Mobiles
{
    ...
    public class Medusa : BaseSABosses, ICarvable
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.Anatomia, 110.6, 116.1);
            SetSkill(SkillName.Intelekt, 100.0, 114.4);
            SetSkill(SkillName.Magia, 100.0);
            SetSkill(SkillName.Medytacja, 118.2, 127.8);
            SetSkill(SkillName.ObronaPrzedMagia, 120.0);
            SetSkill(SkillName.Taktyka, 111.9, 134.5);
            SetSkill(SkillName.Boks, 119.7, 128.9);
