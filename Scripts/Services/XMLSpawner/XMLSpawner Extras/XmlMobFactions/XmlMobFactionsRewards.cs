...
namespace Server.Engines.XmlSpawner2
{
    public class XmlMobFactionsRewards
    {
        ...
        public static void Initialize()
        {
            ...
            MobFactionsRewardList.Add( new XmlMobFactionsRewards( "Player", 1000, typeof(LeatherGlovesOfMining), "+20 Leather Gloves Of Gornictwo", 20000, 0x13c6, new object[] { 20 }));
            ...
            MobFactionsRewardList.Add( new XmlMobFactionsRewards( "Player", 5000, typeof(PowerScroll), "105 Smithing powerscroll", 100000, 0x14F0, new object[] { SkillName.Kowalstwo, 105 }));
            MobFactionsRewardList.Add( new XmlMobFactionsRewards( "Player", 8000, typeof(PowerScroll), "110 Smithing powerscroll", 200000, 0x14F0, new object[] { SkillName.Kowalstwo, 110 }));
            MobFactionsRewardList.Add( new XmlMobFactionsRewards( "Player", 12000, typeof(PowerScroll), "115 Smithing powerscroll", 350000, 0x14F0, new object[] { SkillName.Kowalstwo, 115 }));
            MobFactionsRewardList.Add( new XmlMobFactionsRewards( "Player", 20000, typeof(PowerScroll), "120 Smithing powerscroll", 600000, 0x14F0, new object[] { SkillName.Kowalstwo, 120 }));
