...
namespace Server.Engines.XmlSpawner2
{
    public class XmlPointsRewards
    {
        ...
        public static void Initialize()
        {
            ...
            PointsRewardList.Add( new XmlPointsRewards( 1000, typeof(PowerScroll), "105 Smithing powerscroll", 1000, 0x14F0, new object[] { SkillName.Kowalstwo, 105 }));
            PointsRewardList.Add( new XmlPointsRewards( 2000, typeof(PowerScroll), "110 Smithing powerscroll", 2000, 0x14F0, new object[] { SkillName.Kowalstwo, 110 }));
            PointsRewardList.Add( new XmlPointsRewards( 4000, typeof(PowerScroll), "115 Smithing powerscroll", 4000, 0x14F0, new object[] { SkillName.Kowalstwo, 115 }));
            ...
            PointsRewardList.Add( new XmlPointsRewards( 100, typeof(LeatherGlovesOfMining), "+20 Leather Gloves Of Gornictwo", 200, 0x13c6, new object[] { 20 }));
