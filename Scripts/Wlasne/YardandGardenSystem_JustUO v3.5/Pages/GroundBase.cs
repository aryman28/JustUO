...
//Page 1
			...
			this.AddHtml(86, 96, 246, 243, "<basefont color=#99AA22>To jest zak³adka gruntów.  Ze wzglêdu na ogrom przedmiotów w tej zak³adce, zosta³y one podzielone na 4 kategorie (przyciski powy¿ej).  Kolory : Srebrny = Normalne, Niebieski = Woda, Czerwony = Lawa, Zielony = Bagno.  Aby powrócic do tej zak³adki wciœnij przycisk ponownie.</basefont>", false, false);
