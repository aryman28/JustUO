...
//				case (int)Buttons.Next:			{from.SendGump(new Ground5(from,itemid,price));break;}
				...
				//Pages
				case (int)Buttons.SmallWaveN:	{from.SendGump(new Water2(m_Wand,from,8099,100));break;}
				case (int)Buttons.SmallWaveW:	{from.SendGump(new Water2(m_Wand,from,8104,100));break;}
				case (int)Buttons.SmallWaveE:	{from.SendGump(new Water2(m_Wand,from,8109,100));break;}
				case (int)Buttons.SmallWaveS:	{from.SendGump(new Water2(m_Wand,from,8114,100));break;}
				case (int)Buttons.LargeWaveN:	{from.SendGump(new Water2(m_Wand,from,8119,100));break;}
				case (int)Buttons.LargeWaveW:	{from.SendGump(new Water2(m_Wand,from,8124,100));break;}
				case (int)Buttons.LargeWaveE:	{from.SendGump(new Water2(m_Wand,from,8129,100));break;}
				case (int)Buttons.LargeWaveS:	{from.SendGump(new Water2(m_Wand,from,8134,100));break;}
				case (int)Buttons.Edging1:		{from.SendGump(new Water2(m_Wand,from,6045,50));break;}
				case (int)Buttons.Edging2:		{from.SendGump(new Water2(m_Wand,from,6046,50));break;}
				case (int)Buttons.Edging3:		{from.SendGump(new Water2(m_Wand,from,6047,50));break;}
				case (int)Buttons.Edging4:		{from.SendGump(new Water2(m_Wand,from,6048,50));break;}
				case (int)Buttons.Edging5:		{from.SendGump(new Water2(m_Wand,from,6049,50));break;}
				case (int)Buttons.Edging6:		{from.SendGump(new Water2(m_Wand,from,6050,50));break;}
				case (int)Buttons.Edging7:		{from.SendGump(new Water2(m_Wand,from,6051,50));break;}
				case (int)Buttons.Edging8:		{from.SendGump(new Water2(m_Wand,from,6052,50));break;}
				case (int)Buttons.Edging9:		{from.SendGump(new Water2(m_Wand,from,6053,50));break;}
				case (int)Buttons.Edging10:		{from.SendGump(new Water2(m_Wand,from,6054,50));break;}
				case (int)Buttons.Edging11:		{from.SendGump(new Water2(m_Wand,from,6055,50));break;}
				case (int)Buttons.Edging12:		{from.SendGump(new Water2(m_Wand,from,6056,50));break;}
				case (int)Buttons.Edging13:		{from.SendGump(new Water2(m_Wand,from,6057,50));break;}
				case (int)Buttons.Edging14:		{from.SendGump(new Water2(m_Wand,from,6058,50));break;}
				case (int)Buttons.Edging15:		{from.SendGump(new Water2(m_Wand,from,6059,50));break;}
				case (int)Buttons.Edging16:		{from.SendGump(new Water2(m_Wand,from,6060,50));break;}
			}
		}
