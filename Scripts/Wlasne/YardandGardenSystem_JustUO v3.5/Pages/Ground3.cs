...
//			this.AddLabel(138, 74, 198, "Grunty I Bramki");
			...
			this.AddLabel(250, 291, 1150, @"Ziemia1");
			this.AddButton(232, 296, 5032, 5032, (int)Buttons.Farm1, GumpButtonType.Reply, 0);
			this.AddLabel(250, 311, 1150, @"Ziemia");
			this.AddButton(232, 316, 5032, 5032, (int)Buttons.Farma, GumpButtonType.Reply, 0);
...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case (int)Buttons.Farm1:		{from.SendGump(new Ground3(m_Wand,from,12788,100));break;}
				case (int)Buttons.Farma:		{from.SendGump(new Ground3(m_Wand,from,13001,100));break;}
			}
		}
