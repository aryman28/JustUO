...
//Page 1
			...
			this.AddLabel(170, 74, 172, "Ma³e Drzewa");
...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Tree9T:		{from.SendGump(new Trees3(m_Wand,from,3476,200));break;}
				case (int)Buttons.Leaves9N:		{from.SendGump(new Trees3(m_Wand,from,3477,50));break;}
				case (int)Buttons.Leaves9O:		{from.SendGump(new Trees3(m_Wand,from,3478,50));break;}
				case (int)Buttons.Leaves9F:		{from.SendGump(new Trees3(m_Wand,from,3479,50));break;}
				case (int)Buttons.Tree10T:		{from.SendGump(new Trees3(m_Wand,from,3480,200));break;}
				case (int)Buttons.Leaves10N:	{from.SendGump(new Trees3(m_Wand,from,3481,50));break;}
				case (int)Buttons.Leaves10O:	{from.SendGump(new Trees3(m_Wand,from,3482,50));break;}
				case (int)Buttons.Leaves10F:	{from.SendGump(new Trees3(m_Wand,from,3483,50));break;}
				case (int)Buttons.Tree11T:		{from.SendGump(new Trees3(m_Wand,from,3484,200));break;}
				case (int)Buttons.Leaves11N:	{from.SendGump(new Trees3(m_Wand,from,3485,50));break;}
				case (int)Buttons.Leaves11O:	{from.SendGump(new Trees3(m_Wand,from,3486,50));break;}
				case (int)Buttons.Leaves11F:	{from.SendGump(new Trees3(m_Wand,from,3487,50));break;}
				case (int)Buttons.Tree12T:		{from.SendGump(new Trees3(m_Wand,from,3488,200));break;}
				case (int)Buttons.Leaves12N:	{from.SendGump(new Trees3(m_Wand,from,3489,50));break;}
				case (int)Buttons.Leaves12O:	{from.SendGump(new Trees3(m_Wand,from,3490,50));break;}
				case (int)Buttons.Leaves12F:	{from.SendGump(new Trees3(m_Wand,from,3491,50));break;}
				case (int)Buttons.Tree13T:		{from.SendGump(new Trees3(m_Wand,from,3492,200));break;}
				case (int)Buttons.Leaves13N:	{from.SendGump(new Trees3(m_Wand,from,3493,50));break;}
				case (int)Buttons.Leaves13O:	{from.SendGump(new Trees3(m_Wand,from,3494,50));break;}
				case (int)Buttons.Leaves13F:	{from.SendGump(new Trees3(m_Wand,from,3495,50));break;}
				case (int)Buttons.Tree14T:		{from.SendGump(new Trees3(m_Wand,from,3496,200));break;}
				case (int)Buttons.Leaves14N:	{from.SendGump(new Trees3(m_Wand,from,3497,50));break;}
				case (int)Buttons.Leaves14O:	{from.SendGump(new Trees3(m_Wand,from,3498,50));break;}
				case (int)Buttons.Leaves14F:	{from.SendGump(new Trees3(m_Wand,from,3499,50));break;}
			}
		}
