...
//				case (int)Buttons.Next:				{from.SendGump(new Stairs3(m_Wand,from,0,0));break;}
				//Pages
				case (int)Buttons.Stairs1:			{from.SendGump(new Stairs3(m_Wand,from,1955,50));break;}
				case (int)Buttons.Stairs2:			{from.SendGump(new Stairs3(m_Wand,from,1956,50));break;}
				case (int)Buttons.Stairs3:			{from.SendGump(new Stairs3(m_Wand,from,1960,50));break;}
				case (int)Buttons.Stairs4:			{from.SendGump(new Stairs3(m_Wand,from,1964,50));break;}
				case (int)Buttons.Stairs5:			{from.SendGump(new Stairs3(m_Wand,from,1978,50));break;}
				case (int)Buttons.Stairs6:			{from.SendGump(new Stairs3(m_Wand,from,1979,50));break;}
				case (int)Buttons.Stairs7:			{from.SendGump(new Stairs3(m_Wand,from,1991,50));break;}
				case (int)Buttons.Platform1:		{from.SendGump(new Stairs3(m_Wand,from,1981,50));break;}
				case (int)Buttons.Platform2:		{from.SendGump(new Stairs3(m_Wand,from,1983,50));break;}
				case (int)Buttons.Platform3:		{from.SendGump(new Stairs3(m_Wand,from,1987,50));break;}
				case (int)Buttons.WoodPlanks1:		{from.SendGump(new Stairs3(m_Wand,from,1993,50));break;}
				case (int)Buttons.WoodPlanks2:		{from.SendGump(new Stairs3(m_Wand,from,1997,50));break;}
				case (int)Buttons.Floor1:			{from.SendGump(new Stairs3(m_Wand,from,1173,50));break;}
				case (int)Buttons.Floor2:			{from.SendGump(new Stairs3(m_Wand,from,1193,50));break;}
				case (int)Buttons.Floor3:			{from.SendGump(new Stairs3(m_Wand,from,1250,50));break;}
				case (int)Buttons.Floor4:			{from.SendGump(new Stairs3(m_Wand,from,1289,50));break;}
				case (int)Buttons.Floor5:			{from.SendGump(new Stairs3(m_Wand,from,1294,50));break;}
				case (int)Buttons.Floor6:			{from.SendGump(new Stairs3(m_Wand,from,1301,50));break;}
				case (int)Buttons.Dirt1:			{from.SendGump(new Stairs3(m_Wand,from,1035,50));break;}
				case (int)Buttons.Dirt2:			{from.SendGump(new Stairs3(m_Wand,from,1039,50));break;}
				case (int)Buttons.Dirt3:			{from.SendGump(new Stairs3(m_Wand,from,1043,50));break;}
				case (int)Buttons.Dirt4:			{from.SendGump(new Stairs3(m_Wand,from,1047,50));break;}
				case (int)Buttons.Dirt5:			{from.SendGump(new Stairs3(m_Wand,from,1051,50));break;}
				case (int)Buttons.Dirt6:			{from.SendGump(new Stairs3(m_Wand,from,12789,50));break;}
			}
		}
