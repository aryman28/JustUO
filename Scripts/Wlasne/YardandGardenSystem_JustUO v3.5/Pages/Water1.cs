...
//			Previous,
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.WaterEast:		{from.SendGump(new Water1(m_Wand,from,13422,100));break;}
				case (int)Buttons.WaterSouth:		{from.SendGump(new Water1(m_Wand,from,13460,100));break;}
				case (int)Buttons.WaterStagnant:	{from.SendGump(new Water1(m_Wand,from,6039,100));break;}
				case (int)Buttons.Whirlpool:		{from.SendGump(new Water1(m_Wand,from,13493,100));break;}
				case (int)Buttons.WaterfallE1:		{from.SendGump(new Water1(m_Wand,from,13555,100));break;}
				case (int)Buttons.WaterfallE2:		{from.SendGump(new Water1(m_Wand,from,13549,100));break;}
				case (int)Buttons.WaterfallE3:		{from.SendGump(new Water1(m_Wand,from,13561,100));break;}
				case (int)Buttons.WaterfallE4:		{from.SendGump(new Water1(m_Wand,from,13567,100));break;}
				case (int)Buttons.WaterfallE5:		{from.SendGump(new Water1(m_Wand,from,13573,100));break;}
				case (int)Buttons.WaterfallS1:		{from.SendGump(new Water1(m_Wand,from,13585,100));break;}
				case (int)Buttons.WaterfallS2:		{from.SendGump(new Water1(m_Wand,from,13579,100));break;}
				case (int)Buttons.WaterfallS3:		{from.SendGump(new Water1(m_Wand,from,13591,100));break;}
				case (int)Buttons.WaterfallS4:		{from.SendGump(new Water1(m_Wand,from,13597,100));break;}
				case (int)Buttons.WaterfallS5:		{from.SendGump(new Water1(m_Wand,from,13603,100));break;}
				case (int)Buttons.SmallRockE1:		{from.SendGump(new Water1(m_Wand,from,13446,100));break;}
				case (int)Buttons.SmallRockE2:		{from.SendGump(new Water1(m_Wand,from,13451,100));break;}
				case (int)Buttons.LargeRockE1:		{from.SendGump(new Water1(m_Wand,from,13345,100));break;}
				case (int)Buttons.LargeRockE2:		{from.SendGump(new Water1(m_Wand,from,13356,100));break;}
				case (int)Buttons.SmallRockS1:		{from.SendGump(new Water1(m_Wand,from,13484,100));break;}
				case (int)Buttons.SmallRockS2:		{from.SendGump(new Water1(m_Wand,from,13488,100));break;}
				case (int)Buttons.LargeRockS:		{from.SendGump(new Water1(m_Wand,from,13350,100));break;}
				case (int)Buttons.Post:				{from.SendGump(new Water1(m_Wand,from,942,100));break;}
				case (int)Buttons.Fountain1:		{from.SendGump(new Water1(m_Wand,from,5952,500));break;}
				case (int)Buttons.Fountain2:		{from.SendGump(new Water1(m_Wand,from,6610,500));break;}
			}
		}
