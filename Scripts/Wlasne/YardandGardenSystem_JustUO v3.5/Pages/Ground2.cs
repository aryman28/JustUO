...
//			this.AddLabel(138, 74, 198, "Grunty I Bramki");
...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.TallIronGateNW:	{from.SendGump(new Ground2(m_Wand,from,2084,150));break;}
				case (int)Buttons.TallIronGateEN:	{from.SendGump(new Ground2(m_Wand,from,2085,150));break;}
				case (int)Buttons.TallIronGateNE:	{from.SendGump(new Ground2(m_Wand,from,2086,150));break;}
				case (int)Buttons.TallIronGateWN:	{from.SendGump(new Ground2(m_Wand,from,2087,150));break;}
				case (int)Buttons.TallIronGateSW:	{from.SendGump(new Ground2(m_Wand,from,2088,150));break;}
				case (int)Buttons.TallIronGateSE:	{from.SendGump(new Ground2(m_Wand,from,2090,150));break;}
				case (int)Buttons.ShortIronGateNW:	{from.SendGump(new Ground2(m_Wand,from,2124,150));break;}
				case (int)Buttons.ShortIronGateEN:	{from.SendGump(new Ground2(m_Wand,from,2125,150));break;}
				case (int)Buttons.ShortIronGateNE:	{from.SendGump(new Ground2(m_Wand,from,2126,150));break;}
				case (int)Buttons.ShortIronGateWN:	{from.SendGump(new Ground2(m_Wand,from,2127,150));break;}
				case (int)Buttons.ShortIronGateSW:	{from.SendGump(new Ground2(m_Wand,from,2128,150));break;}
				case (int)Buttons.ShortIronGateSE:	{from.SendGump(new Ground2(m_Wand,from,2130,150));break;}
				case (int)Buttons.LightWoodNW:		{from.SendGump(new Ground2(m_Wand,from,2105,150));break;}
				case (int)Buttons.LightWoodEN:		{from.SendGump(new Ground2(m_Wand,from,2106,150));break;}
				case (int)Buttons.LightWoodNE:		{from.SendGump(new Ground2(m_Wand,from,2107,150));break;}
				case (int)Buttons.LightWoodWN:		{from.SendGump(new Ground2(m_Wand,from,2108,150));break;}
				case (int)Buttons.LightWoodSW:		{from.SendGump(new Ground2(m_Wand,from,2109,150));break;}
				case (int)Buttons.LightWoodSE:		{from.SendGump(new Ground2(m_Wand,from,2111,150));break;}
				case (int)Buttons.DarkWoodNW:		{from.SendGump(new Ground2(m_Wand,from,2150,150));break;}
				case (int)Buttons.DarkWoodEN:		{from.SendGump(new Ground2(m_Wand,from,2151,150));break;}
				case (int)Buttons.DarkWoodNE:		{from.SendGump(new Ground2(m_Wand,from,2152,150));break;}
				case (int)Buttons.DarkWoodWN:		{from.SendGump(new Ground2(m_Wand,from,2153,150));break;}
				case (int)Buttons.DarkWoodSW:		{from.SendGump(new Ground2(m_Wand,from,2154,150));break;}
				case (int)Buttons.DarkWoodSE:		{from.SendGump(new Ground2(m_Wand,from,2156,150));break;}
			}
		}
		...
		{
			from.SendMessage( "Gdzie chcesz dodaæ przedmiot" );
