...
//Page 1
			...
			this.AddHtml(86, 96, 246, 243, "<basefont color=#99AA22>To jest zak³adka drzew.  Drzewa sk³adaj¹ siê z czêœci, pieñ i liœcie.  Sa 2 typy liœci, normalne i opadaj¹ce.  Du¿e drzewa (Yew) wystêpuj¹ jaki jeden przedmiot.</basefont>", false, false);
			...
			this.AddLabel(172, 74, 172, "Drzewa");
...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case (int)Buttons.Next:		{from.SendGump(new Trees2(m_Wand,from,itemid,price));break;}
				//Pages
			}
		}
		...
		public void Place( Mobile from, int itemid, int p )
		{
			...
			from.Target = new YardTarget( m_Wand, from, itemid, p, 14 );
		}
	}
}
