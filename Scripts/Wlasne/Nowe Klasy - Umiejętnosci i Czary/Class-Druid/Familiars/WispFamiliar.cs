...
namespace Server.Mobiles
{
	...
	public class WispFamiliar : BaseFamiliar
	{
		public WispFamiliar()
		{
			Name = "a wisp";
			...
			SetSkill( SkillName.Boks, 40.0 );
			SetSkill( SkillName.Taktyka, 40.0 );
		...
		private void Flare()
		{
			...
			for ( int i = 0; i < list.Count; ++i )
			{
				...
				if ( friendly )
				{
					...
					m.Hits += 1 + (m.Karma / 1000);
				}
			}
		}
		
		public WispFamiliar( Serial serial ) : base( serial )
		{
		}
