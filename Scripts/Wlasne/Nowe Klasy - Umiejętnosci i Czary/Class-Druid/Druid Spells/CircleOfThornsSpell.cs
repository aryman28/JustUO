...
{
    public class CircleOfThornsSpell : DruidSpell
    {
        private InternalItem m_Circlea;

        private static SpellInfo m_Info = new SpellInfo
            (
              "Ciernisty okrąg", "En Ess Ohm",
            //SpellCircle.Sixth,
              266,
              9040,
              false,
        ...
        public override string SpellDescription
        {
            get
            {
                return "Zamyka przeciwnika w ciernistym okręgu uniemożliwiając mu poruaszanie się.";
            }
        }
        ...
        public CircleOfThornsSpell(Mobile caster, Item scroll)
        ...
        private class InternalItem : Item
        {
                ...
                : base(0x3023) //0x08E2
            {
                ...
                ItemID = Utility.RandomList(12320, 12321, 12322, 12323, 12324);
                Name = "thistle barbs";
                MoveToWorld(loc, map);
                m_Caster = caster;
            ...
            {
                m.SendMessage("The thistle barbs prevent you from moving.");
                return false;
        ...
        {
            private CircleOfThornsSpell m_Owner;

            public InternalTarget(CircleOfThornsSpell owner)
