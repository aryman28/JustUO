...
namespace Server.Spells.Druid
{
    public class SpringOfLifeSpell : DruidSpell
    {
        ...
        public override string SpellDescription
        {
            get
            {
                return "Tworzy magiczne zródło które odnawia życie tobie oraz członkom twojej drużyny.";
            }
        }
