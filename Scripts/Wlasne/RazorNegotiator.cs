...
namespace Server.Misc
{
	public class RazorFeatureControl
	{
		...
		public const string WarningMessage = "serwer nie wykry³ aktywnej funkcji : negocjacja z serwerem w asystentach Razor/UOSteam.<BR>Musisz zawsze u¿ywaæ najnowszej wersji Razora/UOSteam do pobrania z naszej strony WWW</A> aby zagraæ na naszym serwerze.<BR>Kiedy ju¿ masz zainstalowany Razor/UOSteam i uruchomisz go idz do sekcji <B>Options</B> i sprawdz czy opcja <B>Negotiate features with server</B> jest aktywna je¿eli nie zaznacz j¹. Je¿eli bêdzie ona aktywna mo¿esz wtedy z powodzeniem graæ na naszym serwerze.<BR>Po krótkim czasie zostaniesz roz³¹czony.";
