...
namespace Server.Mobiles
{
	...
	public class KamiennyDrakon : BaseCreature
	{
		[Constructable]
		public KamiennyDrakon() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "kamienny drakon";
			Body = 273;
			BaseSoundID = 362;
		...
		public KamiennyDrakon( Serial serial ) : base( serial )
		{
		}
