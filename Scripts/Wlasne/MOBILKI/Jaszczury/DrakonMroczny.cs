...
{
	[CorpseName( "zwloki mrocznego drakona" )]
	public class MrocznyDrakon : BaseCreature
	{
		[Constructable]
		public MrocznyDrakon() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "mroczny drakon";
			Body = 41;
			BaseSoundID = 362;
		...
		public MrocznyDrakon( Serial serial ) : base( serial )
		{
		}
