...
{
	[CorpseName( "zwloki koscianego drakona" )]
	public class KoscianyDrakon : BaseCreature
	{
		[Constructable]
		public KoscianyDrakon() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "kosciany drakon";
			Body = 264;
			BaseSoundID = 362;
		...
		public KoscianyDrakon( Serial serial ) : base( serial )
		{
		}
