...
namespace Server.Mobiles
{
	...
	public class StygijskiWodnySmok : BaseCreature
	{
		[Constructable]
		public StygijskiWodnySmok() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "stygijski wodny smok";
			Body = 826;
			BaseSoundID = 362;
		...
		public StygijskiWodnySmok( Serial serial ) : base( serial )
		{
		}
