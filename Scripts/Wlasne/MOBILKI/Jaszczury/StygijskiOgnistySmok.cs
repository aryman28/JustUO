...
{
	[CorpseName( "zwloki stygijskiego smoka" )]
	public class StygijskiOgnistySmok : BaseCreature
	{
		[Constructable]
		public StygijskiOgnistySmok() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "stygijski ognisty smok";
			Body = 826;
			BaseSoundID = 362;
		...
		public StygijskiOgnistySmok( Serial serial ) : base( serial )
		{
		}
