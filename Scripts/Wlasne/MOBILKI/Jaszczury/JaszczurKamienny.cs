...
namespace Server.Mobiles
{
	...
	public class KamiennyJaszczur : BaseCreature
	{
		[Constructable]
		public KamiennyJaszczur () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public KamiennyJaszczur( Serial serial ) : base( serial )
		{
		}
