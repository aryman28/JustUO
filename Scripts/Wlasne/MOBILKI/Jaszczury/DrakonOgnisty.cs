...
{
	[CorpseName( "zwloki ognistego drakona" )]
	public class OgnistyDrakon : BaseCreature
	{
		[Constructable]
		public OgnistyDrakon() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "ognisty drakon";
			Body = 272;
			BaseSoundID = 362;
		...
		public OgnistyDrakon( Serial serial ) : base( serial )
		{
		}
