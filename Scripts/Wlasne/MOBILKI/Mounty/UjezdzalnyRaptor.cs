...
namespace Server.Mobiles
{
	...
	public class UjezdzalnyRaptor : BaseMount
	{
		[Constructable]
		public UjezdzalnyRaptor() : this( "raptor" )
		{
		}

		[Constructable]
		public UjezdzalnyRaptor( string name ) : base( name, 0xD2, 0x3F0C, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
                        Body = 210;
			BaseSoundID = 0x275;
		...
		public UjezdzalnyRaptor( Serial serial ) : base( serial )
		{
		}
