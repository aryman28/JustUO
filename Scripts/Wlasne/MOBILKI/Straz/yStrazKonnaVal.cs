...
namespace Server.Mobiles
{
	...
	public class StrazKonnaVal : BaseCreature
	{
	...
	return WeaponAbility.Dismount;
		...
		[Constructable]
		public StrazKonnaVal() : base( AIType.AI_Guard, FightMode.Red, 10, 1, 0.015, 0.01 )
		{
			SetStr( 100 );
			SetDex( 80 );
			SetInt( 80, 110 );
      ...
      Skills[SkillName.Parowanie].Base = 100.0;
		...
		public StrazKonnaVal(Serial serial) : base(serial)
		{
		}
