...
namespace Server.Mobiles
{
	...
	public class StrazPieszaVal : BaseCreature
	{
	...
	return WeaponAbility.ArmorIgnore;
		...
		[Constructable]
		public StrazPieszaVal() : base( AIType.AI_Guard, FightMode.Red, 10, 1, 0.015, 0.01 )
		{
			SetStr( 100 );
			SetDex( 80 );
			SetInt( 80, 110 );
      ...
      Skills[SkillName.Parowanie].Base = 100.0;
		...
		public StrazPieszaVal(Serial serial) : base(serial)
		{
		}
