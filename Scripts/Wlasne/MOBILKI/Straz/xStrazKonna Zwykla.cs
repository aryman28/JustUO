...
namespace Server.Mobiles
{
	...
	public class StrazKonnaZwykla : BaseCreature
	{
	...
	return WeaponAbility.Dismount;
		...
		[Constructable]
		public StrazKonnaZwykla() : base( AIType.AI_Guard, FightMode.Red, 10, 1, 0.015, 0.01 )
		{
			SetStr( 100 );
			SetDex( 100 );
			SetInt( 100, 110 );
      ...
      Skills[SkillName.Parowanie].Base = 100.0;
		...
		public StrazKonnaZwykla(Serial serial) : base(serial)
		{
		}
