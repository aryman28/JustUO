...
{
	[CorpseName( "zwloki paladyna" )]
	public class Paladyn : BaseCreature
	{
	...
	return WeaponAbility.CrushingBlow;
		...
		[Constructable]
		public Paladyn() : base( AIType.AI_Paladin, FightMode.Red, 10, 1, 0.015, 0.01 )
		{
			SetStr( 100 );
			SetDex( 80 );
			SetInt( 50, 80 );
			...
			Hue = Utility.RandomSkinHue();
				...
				weapon.Quality = WeaponQuality.Legendarn; 
      ...
      Skills[SkillName.Parowanie].Base = 100.0;
		...
		public Paladyn(Serial serial) : base(serial)
		{
		}
