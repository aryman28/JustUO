...
{
	public class FryzuraMêskaGump : Gump
	{
		public FryzuraMêskaGump()
			: base( 0, 0 )
		{
			this.Closable=false;
...
////Prawa Strona
			...
			this.AddButton(340, 523, 4502, 4502, (int)Buttons.Button13, GumpButtonType.Reply, 0);
                        ...
                        this.AddImage(205, 23, 0x754);
			this.AddLabel(180, 170, 567, @"W£OSY KRÓTRKIE");
                        this.AddImage(205, 93, 0x753);
			this.AddLabel(180, 240, 567, @"W£OSY W KUC");
                        this.AddImage(205, 163, 0x757);
			this.AddLabel(180, 310, 567, @"AFRO");
                        this.AddImage(205, 233, 0x751);
			this.AddLabel(180, 380, 567, @"NA PAZIA");
                        this.AddImage(205, 303, 0x74F);
			this.AddLabel(180, 450, 567, @"IROKEZ");
                        this.AddImage(205, 373, 0x755);
////Prawa Strona
                        this.AddLabel(400, 100, 567, @"DWA WARKOCZE");   
                        this.AddImage(425, 23, 0x74E);
			this.AddLabel(400, 170, 567, @"KOK");
                        this.AddImage(425, 93, 0x752);
			this.AddLabel(400, 240, 567, @"DREDY");
                        this.AddImage(425, 163, 0x750);
			this.AddLabel(400, 310, 567, @"CZUPRYNA");
                        this.AddImage(425, 233, 0x756);
		...
		{                  
			...
			switch ( info.ButtonID )
			{
				...
				pm.HairItemID = 0x203C;
                                ...
                                m.CloseGump( typeof ( FryzuraMêskaGump ) );
