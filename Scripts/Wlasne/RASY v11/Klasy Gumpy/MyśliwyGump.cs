	...
	public class MyœliwyGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddButton(340, 523, 4502, 4502, (int)Buttons.Button9, GumpButtonType.Reply, 0);
                        ...
                        this.AddLabel(210, 100, 917, @"WYTWARZANIE £UKÓW (+50%)");
			this.AddLabel(210, 130, 917, @"OBOZOWANIE (+50%)");
			this.AddLabel(210, 160, 917, @"UKRYWANIE (+50%)");
			this.AddLabel(210, 190, 917, @"WYKRYWANIE UKRYTYCH(+50%)");
			this.AddLabel(210, 220, 917, @"TROPIENIE (+50%)");
                        this.AddLabel(210, 250, 917, @"LOGISTYKA (+50%)");
                        this.AddLabel(210, 280, 917, @"USUWANIE PU£APEK (+50%)");
     			
     			this.AddLabel(150, 310, 137, @"Myœliwy mo¿e awansowaæ do klasy presti¿owej - £ucznik -> £owca");
		...
		{                  
			...
			switch ( info.ButtonID )
			{
				...
				case 2: 
				{
                                pm.Skills[SkillName.Obozowanie].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
				break; 
				}
				...
				case 4: 
				{
                                pm.Skills[SkillName.Wykrywanie].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
				break; 
				}
				...
				case 5: 
				{
                                pm.Skills[SkillName.Tropienie].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
				break; 
				}
				...
				case 7: 
				{
                                pm.Skills[SkillName.UsuwaniePulapek].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
				break; 
				}
