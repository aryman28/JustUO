	...
	public class ZnachorGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddButton(340, 523, 4502, 4502, (int)Buttons.Button6, GumpButtonType.Reply, 0);
                        ...
                        this.AddLabel(210, 100, 917, @"ANATOMIA (+50%)");
                        this.AddLabel(210, 130, 917, @"ALCHEMIA (+50%)");
                        this.AddLabel(210, 160, 917, @"LECZENIE (+50%)");
                        this.AddLabel(210, 190, 917, @"ZIELARSTWO (+50%)");
     			
     			this.AddLabel(150, 220, 137, @"Znachor mo¿e awansowaæ do klasy presti¿owej - Lekarz -> Uzdrowiciel");
		...
		{                  
			...
			switch ( info.ButtonID )
			{
				...
				case 1:
				{						            
                                pm.Skills[SkillName.Anatomia].Base += 50;
				...
				case 3:
				{						            
                                pm.Skills[SkillName.Leczenie].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
         		        break; 
				}
