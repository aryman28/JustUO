...
namespace Server.Gumps
{
	...
	public class WojownikGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddLabel(210, 190, 917, @"ODPORNOŒÆ NA MAGIE (+50%)");
			this.AddLabel(210, 220, 917, @"ZNAJOMOŒÆ ORE¯A (+50%)");
     			
     			this.AddLabel(150, 250, 137, @"Wojownik mo¿e awansowaæ do klasy presti¿owej - Rycerz -> Paladyn");
     			this.AddLabel(150, 280, 137, @"oraz w przypadku chaotycznej frakcji - Mroczny Rycerz -> Mœciciel");
