	...
	public class DzikusGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddButton(340, 523, 4502, 4502, (int)Buttons.Button5, GumpButtonType.Reply, 0);
                        ...
                        this.AddLabel(210, 100, 917, @"OSWAJANIE(+50%)");
                        this.AddLabel(210, 130, 917, @"WETERYNARIA (+50%)");
                        this.AddLabel(210, 160, 917, @"ZNAJOMOŒÆ ZWIERZ¥T (+50%)");
     			
     			this.AddLabel(150, 190, 137, @"Dzikus mo¿e awansowaæ do klasy presti¿owej - Oswajacz");
     			this.AddLabel(150, 220, 137, @"-> Poskramiacz Bestii");
		...
		{                  
			...
			switch ( info.ButtonID )
			{
				...
				case 1:
				{						            
                                pm.Skills[SkillName.Oswajanie].Base += 50;
				...
				case 2:
				{						            
                                pm.Skills[SkillName.Weterynaria].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
         		        break; 
				}
				...
				case 3:
				{						            
                                pm.Skills[SkillName.WiedzaOBestiach].Base += 50;
                                m.SendGump( new BudowaCia³aGump());
         		        break; 
				}
