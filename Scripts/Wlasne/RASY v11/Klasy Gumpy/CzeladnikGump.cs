	...
	public class CzeladnikGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddButton(340, 523, 4502, 4502, (int)Buttons.Button12, GumpButtonType.Reply, 0);
                        ...
                        this.AddLabel(210, 100, 917, @"GÓRNICTWO (+50%)");
			...
			this.AddLabel(210, 220, 917, @"KRAWIECTWO (+50%)");
                        ...
                        this.AddLabel(210, 340, 917, @"WYTWARZANIE £UKÓW(+50%)");
                        this.AddLabel(210, 370, 917, @"ZNAJOMOŒÆ ORÊ¯A (+50%)");
 
     			this.AddLabel(150, 400, 137, @"Czeladnik mo¿e awansowaæ do klasy presti¿owej - Rzemieœlnik");
