...
namespace Server.Items
{
    ...
    public class GiermekNaramienniki : BaseArmor
    {
        ...
        [Constructable]
        public GiermekNaramienniki()
            : base(0x13DC)
        {
            this.Weight = 4.0;
            this.Name = "Skórzane Utwardzane Naramienniki";
            SetHue = 0x1E8;
        ...
        public GiermekNaramienniki(Serial serial)
            : base(serial)
        {
        }
