...
{
    public abstract class LockableDrakanContainer : TrapableContainer, IXOLockable, ILockpickable, ICraftable, IShipwreckedItem
    {
        ...
        public LockableDrakanContainer(int itemID)
            : base(itemID)
        {
            this.m_MaxLockLevel = 100;
        }

        public LockableDrakanContainer(Serial serial)
            : base(serial)
        {
        }
