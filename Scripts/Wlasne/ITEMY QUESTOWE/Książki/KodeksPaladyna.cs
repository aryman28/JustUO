...
{
	public class KodeksPaladyna : BlueBook
	{
		[Constructable]
		public KodeksPaladyna() : base( "Kodeks Paladyna", "skryba Vega ", 19, false ) // true writable so players can make notes
		{
		...
		public KodeksPaladyna( Serial serial ) : base( serial )
		{
		}
