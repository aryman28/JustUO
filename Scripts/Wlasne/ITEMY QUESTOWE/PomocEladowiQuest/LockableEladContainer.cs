...
{
    public abstract class LockableEladContainer : TrapableContainer, IXLockable, ILockpickable, ICraftable, IShipwreckedItem
    {
        ...
        public LockableEladContainer(int itemID)
            : base(itemID)
        {
            this.m_MaxLockLevel = 100;
        }

        public LockableEladContainer(Serial serial)
            : base(serial)
        {
        }
