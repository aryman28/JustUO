...
{
    public abstract class LockableTajemniczyContainer : TrapableContainer, IYLockable, ILockpickable, ICraftable, IShipwreckedItem
    {
        ...
        public LockableTajemniczyContainer(int itemID)
            : base(itemID)
        {
            this.m_MaxLockLevel = 100;
        }

        public LockableTajemniczyContainer(Serial serial)
            : base(serial)
        {
        }
