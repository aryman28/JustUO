...
namespace Server.Auction
{
    class ViewItemGump : BaseGridGump
    {
            ...
            : base(50, 50)
        {
            ...
            AddEntryButton(20, ArrowRightID1, ArrowRightID2, 1, ArrowRightWidth, ArrowRightHeight); AddEntryHtml(479, "ZOBACZ PRZEDMIT"); AddNewLine();
            AddEntryButton(20, ArrowRightID1, ArrowRightID2, 2, ArrowRightWidth, ArrowRightHeight); AddEntryHtml(59, "LICYTUJ"); AddEntryText(119, 0, (minprice).ToString()); AddEntryHeader(299);
