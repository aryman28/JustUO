...
namespace Server.Auction
{
    class AddAuctionGump : BaseGridGump
    {
            ...
            : base((640 - 320) / 2, (480 - 100) / 2)
        {
            ...
            AddEntryHtml(100, StringList.ItemHeader); AddEntryText(200, 0, param[0] ?? i.Name); AddNewLine();
            AddEntryHtml(100, StringList.DescHeader); AddEntryText(200, 1, param[1] ?? i.Name); AddNewLine();
            AddEntryHtml(100, StringList.PriceHeader); AddEntryText(200, 2, param[2] ?? "1000"); AddNewLine();
