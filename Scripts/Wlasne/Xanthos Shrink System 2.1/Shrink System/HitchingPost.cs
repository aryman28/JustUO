...
namespace Xanthos.ShrinkSystem
{
	...
	public class HitchingPost : AddonComponent, IShrinkTool
	{
		...
		public override void AddNameProperties( ObjectPropertyList list )
		{
			...
			if ( m_Charges >= 0 )
				list.Add( 1060658, "Uzyc\t{0}", m_Charges.ToString() );
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.Skills[SkillName.Oswajanie].Value >= ShrinkConfig.TamingRequired )
				from.Target = new ShrinkTarget( from, this, false );
				
			else
				from.SendMessage( "Musisz miec " + ShrinkConfig.TamingRequired + " oswajania aby uzyc tego slupka." );
		}
	...
	public class HitchingPostEastDeed : BaseAddonDeed
	{
		...
		{
			Name = "Slupek do przywiazywania (wschod)";
		}
	...
	public class HitchingPostSouthDeed : BaseAddonDeed
	{
		...
		{
			Name = "Slupek do przywiazywania (poludnie)";
		}
