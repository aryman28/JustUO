...
namespace Server.Items
{
    public abstract class BaseSpear : BaseMeleeWeapon
    {
        ...
        public override void OnHit(Mobile attacker, Mobile defender, double damageBonus)
        {
            ...
            if (!Core.AOS && this.Layer == Layer.TwoHanded && (attacker.Skills[SkillName.Anatomia].Value / 400.0) >= Utility.RandomDouble() && Engines.ConPVP.DuelContext.AllowSpecialAbility(attacker, "Paralyzing Blow", false))
            {
