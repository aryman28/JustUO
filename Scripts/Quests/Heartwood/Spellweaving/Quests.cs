...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        {
            return MondainsLegacy.Druidyzm;
        }
    ...
    { 
        ...
        { 
            ...
            this.AddReward(new BaseReward(typeof(SpellweavingBook), 1031600)); // Druidyzm Spellbook
        }
