...
namespace Server.Mobiles
{
    ...
    public class GargoyleGuardian : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.None, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ObronaPrzedMagia, 120.4, 160.0);
            this.SetSkill(SkillName.Anatomia, 50.5, 100.0);
            this.SetSkill(SkillName.WalkaMieczami, 90.1, 100.0);
            this.SetSkill(SkillName.WalkaObuchami, 90.1, 100.0);
            this.SetSkill(SkillName.WalkaSzpadami, 90.1, 100.0);
            this.SetSkill(SkillName.Magia, 90.1, 100.2);
