...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* Head East out of town and go to Old Haven. Battle monster there until you have raised your Boks skill to 50.
        ...
        public TheRudimentsOfSelfDefenseQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Boks, 50, "Old Haven Training", 1077492, 1077586));
			
            // 1077492 Your Boks potential is greatly enhanced while questing in this area.
            // 1077586 You are not in the quest area for Apprentice Wrestler. Your Boks potential is not enhanced here.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Boks.Base < 50;
        }
    ...
    public class Dimethro : MondainQuester
    {
        ...
        [Constructable]
        public Dimethro()
            : base("Dimethro", "The Boks Instructor")
        { 
