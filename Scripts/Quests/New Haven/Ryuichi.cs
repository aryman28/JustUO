...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        and summon mirror images up to 40 Skrytobojstwo skill, and continue practicing focus attack on monsters until 50 Skrytobojstwo 
        skill. Welcome, young one. You seek to learn Skrytobojstwo. With it, and the book of Skrytobojstwo, a Ninja can envoke a number 
        of special abilites including transforming into a variety of creatures that give unique bonuses, using stealth to 
        attack unsuspecting opponents or just plain disappear into thin air! If you do not have a book of Skrytobojstwo , you can 
        ...
        /* Come back to me if you want to learn Skrytobojstwo in the future.. */
        ...
        public TheArtOfStealthQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Skrytobojstwo, 50, "Old Haven Training", 1078156, 1078157));
			
            // 1078156 You feel a greater sense of awareness here. Your ability to hone your Skrytobojstwo skill is enhanced in this area.
            // 1078157 You feel your sense of awareness is normal here. Your Skrytobojstwo learning potential is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Skrytobojstwo.Base < 50;
        }
    ...
    public class Ryuichi : MondainQuester
    {
        ...
        [Constructable]
        public Ryuichi()
            : base("Ryuichi", "The Skrytobojstwo Instructor")
        { 
        ...
        {
            this.Say(1078155); // I can teach you Skrytobojstwo. The Art of Zakradanie.
        }
