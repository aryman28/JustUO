...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        Nekromancja skill to 50.<br><center>------</center><br>Welcome! I see you are allured by the dark magic of Nekromancja. First, 
        you must prove yourself worthy of such knowledge. Undead currently occupy the town of Old Haven. Practice your harmful Nekromancja 
        ...
        Reagents are required to cast Nekromancja spells. You can purchase extra reagents from me, or you can find reagents growing in 
        ...
        /* You are weak after all. Come back to me when you are ready to practice Nekromancja. */
        ...
        public TheAllureOfDarkMagicQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Nekromancja, 50, "Old Haven Training", 1078037, 1078038));
			
            // 1078037 Your Nekromancja potential is greatly enhanced while questing in this area.
            // 1078038 You are not in the quest area for Apprentice Necromancer. Your Nekromancja potential is not enhanced here.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Nekromancja.Base < 50;
        }
