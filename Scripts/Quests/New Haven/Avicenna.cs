...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        Leczenie skill to 50.<br><center>------</center><br>Ah, welcome to my humble practice. I am Avicenna, New 
        ...
        public BruisesBandagesAndBloodQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Leczenie, 50, "Old Haven Training", 1077677, 1077678));
			
            // 1077677 You feel fresh and are eager to heal wounds. Your ability to improve your Leczenie skill is enhanced in this area.
            // 1077678 You feel as if you've seen enough blood to last a lifetime. Your Leczenie learning potential is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Leczenie.Base < 50;
        }
    ...
    public class Avicenna : MondainQuester
    {
        ...
        [Constructable]
        public Avicenna()
            : base("Avicenna", "The Leczenie Instructor")
        { 
