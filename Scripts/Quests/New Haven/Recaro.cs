...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        club or butchering an enemy with a sword. Learn the art of WalkaSzpadami if you want to master combat and look good 
        ...
        /* Excellent! You are beginning to appreciate the art of WalkaSzpadami. I told you fighting with elegance and precision 
        ...
        public EnGuardeQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.WalkaSzpadami, 50, "Old Haven Training", 1078188, 1078189));	
			
            // 1078188 You feel more dexterous and quick witted while practicing combat here. Your ability to raise your WalkaSzpadami skill is enhanced in this area.
            // 1078189 You feel less dexterous here. Your WalkaSzpadami learning potential is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.WalkaSzpadami.Base < 50;
        }
