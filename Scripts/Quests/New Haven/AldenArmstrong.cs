...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* Head East out of town to Old Haven. Battle monsters there until you have raised your Taktyka skill 
        ...
        public TheArtOfWarQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Taktyka, 50, "Old Haven Training", 1077668, 1077669));
			
            // 1077668 You feel like practicing combat here would really help you learn to fight better. Your ability to raise your Taktyka skill is enhanced in this area.
            // 1077669 You feel less able to absorb the lessons of combat. Your Taktyka learning potential is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Taktyka.Base < 50;
        }
    ...
    public class AldenArmstrong : MondainQuester
    {
        ...
        public AldenArmstrong()
            : base("Alden Armstrong", "The Taktyka Instructor")
        { 
