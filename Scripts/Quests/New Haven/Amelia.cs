...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        Majsterkowanie, eh? You've come to the right place, as Majsterkowanie is what I've dedicated my life to. <br><br>You'll need 
        ...
        /* I’m disappointed that you aren’t interested in learning more about Majsterkowanie. It’s really such a useful skill!<br><br>
        *Amelia smiles*<br><br>At least you know where to find me if you change your mind, since I rarely spend time outside 
        ...
        /* Nice going! You're not quite at Apprentice Majsterkowanie yet, though, so you better get back to work. Remember that the 
        ...
        public TheRightToolForTheJobQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Majsterkowanie, 50, "Springs And Things Workshop", 1077742, 1077743));
			
            // 1077742 By tinkering inside of Amelia’s workshop, she is able to give you advice. This helps you hone your Majsterkowanie skill faster than normal.
            // 1077743 Since you’ve left Amelia’s workshop, she cannot give you advice. Your Majsterkowanie learning potential is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Majsterkowanie.Base < 50;
        }
    ...
    public class Amelia : MondainQuester
    {
        ...
        [Constructable]
        public Amelia()
            : base("Amelia Youngstone", "The Majsterkowanie Instructor")
        { 
        ...
        {
            this.Say(1078123); // Majsterkowanie is very useful for a blacksmith. You can make your own tools.
        }
