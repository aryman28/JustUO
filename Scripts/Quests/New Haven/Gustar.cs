...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        raised your Medytacja skill to 50.	Well met! I can teach you how to 'Stop the World' around you and focus your inner energies 
        ...
        practitioner of the arcane. Those of us who study the art of Medytacja are also known as stotics. The Medytacja skill allows 
        ...
        before he can meditate to replenish it. Medytacja can occur passively or actively. Actively Medytacja is more difficult to 
        ...
        properties of Medytacja. It is wise to wear leather or cloth protection when meditating. Head east out of town and go to Old 
        ...
        /* Seek me out if you ever wish to study the art of Medytacja. Good journey. */
        ...
        public StoppingTheWorldQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Medytacja, 50, "Old Haven Training", 1077490, 1077584));
			
            // 1077490 Your Medytacja potential is greatly enhanced while questing in this area.
            // 1077584 You are not in the quest area for Apprentice Stoic. Your Medytacja potential is not enhanced here.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Medytacja.Base < 50;
        }
		
        public override void OnCompleted()
        { 
            this.Owner.SendLocalizedMessage(1077600, null, 0x23); // You have achieved the rank of Apprentice Stoic (for Medytacja). Return to Gustar in New Haven to receive your arcane prize.
    ...
    public class Gustar : MondainQuester
    {
        ...
        [Constructable]
        public Gustar()
            : base("Gustar", "The Medytacja Instructor")
        { 
        ...
        {
            this.Say(1078126); // Medytacja allows a mage to replenish mana quickly. I can teach you.
        }
