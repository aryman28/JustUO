...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        you have raised your Rycerstwo skill to 50.<br><center>------</center><br>Hail, friend. The life of a Paladin is 
        ...
        /* Well done, friend. While I know you understand Rycerstwo is its own reward, I would like to reward you with 
        ...
        public CleansingOldHavenQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Rycerstwo, 50, "Old Haven Training", 1077720, 1077721));
			
            // 1077720 Your Rycerstwo potential is greatly enhanced while questing in this area.
            // 1077721 You are not in the quest area for Apprentice Paladin. Your Rycerstwo potential is not enhanced here.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Rycerstwo.Base < 50;
        }
    ...
    public class Aelorn : MondainQuester
    {
        ...
        [Constructable]
        public Aelorn()
            : base("Aelorn", "The Rycerstwo Instructor")
        { 
            ...
            this.SetSkill(SkillName.Rycerstwo, 120.0, 120.0);
        }
