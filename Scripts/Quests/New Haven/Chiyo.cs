...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* Practice hiding in the Ninja Dojo until you reach 50 Ukrywanie skill.<br><center>------</center><br>Come closer. 
        ...
        me once you have achieved the rank of Apprentice Rogue (for Ukrywanie), and I shall reward you. */ 
        ...
        /* You have not achieved the rank of Apprentice Rogue (for Ukrywanie). Talk to me when you feel you have accomplished 
        this. */
        ...
        you haven't already talked to Jun, I advise you do so. Jun can teach you how to stealth undetected. Ukrywanie and 
        Zakradanie are essential skills to master when becoming a Ninja.<br><br>As promised, I have a reward for you. Here are 
        ...
        public BecomingOneWithTheShadowsQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Ukrywanie, 50, "Haven Dojo", 1078166, 1078167));
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Ukrywanie.Base < 50;
        }
		
        public override void OnCompleted()
        { 
            this.Owner.SendLocalizedMessage(1078171, null, 0x23); // You have achieved the rank of Apprentice Rogue (for Ukrywanie). Return to Chiyo in New Haven to claim your reward.
    ...
    public class Chiyo : MondainQuester
    {
        ...
        [Constructable]
        public Chiyo()
            : base("Chiyo", "The Ukrywanie Instructor")
        { 
