...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* Track animals, monsters, and people on Haven Island until you have raised your Tropienie skill to 50.	Hello Friend. I am 
        Walker, Grandmaster Ranger. An adventurer need to keep alive in the wilderness. Being able to track those around you is 
        essential to surviving in dangerous places.Certain Ninja abilites are more potent when the Ninja possesses Tropienie knowledge. 
        ...
        Come back to me once you have achibed the rank of Apprentice Ranger (for Tropienie), and i will give you something that may 
        ...
        /* Farewell, friend. Be careful out here. If you change your mind and want to learn Tropienie come back and talk to me.*/
        ...
        /* So far so good, kid. You are still alive, and you are getting the hang of Tropienie. There are many more animals, monsters, 
        ...
        public EyesOfRangerQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Tropienie, 50, "Enhanced Tropienie Skill", 1078215, 1078216));
			
            // 1078215 You feel you can track creatures here with ease. Your Tropienie skill is enhanced in this area.
            // 1078216 You feel it is more difficult to track creatures here. Your Tropienie skill is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Tropienie.Base < 50;
        }
		
        public override void OnCompleted()
        { 
            this.Owner.SendLocalizedMessage(1078220, null, 0x23); // You have achieved the rank of Apprentice Ranger (for Tropienie). Return to Walker in New Haven to claim your reward.
    ...
    public class Walker : MondainQuester
    {
        ...
        [Constructable]
        public Walker()
            : base("Walker", "The Tropienie Instructor")
        { 
