...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* While Here ar the New Haven Magia Library, use scribe's pen and scribe 3rd and 4th circle Magia scrolls that 
        you have in your spellbook. Remeber, you will need blank scrolls aswell. Do this until you have raised your Inscription 
        skill to 50. Greetings and welcome to the New Haven Magia Library! You wish to learn how to scribe spell scrolls? You 
        ...
        public ScribingArcaneKnowledgeQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Inskrypcja, 50, "Haven Library", 1077493, 1077587));
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Inskrypcja.Base < 50;
        }
