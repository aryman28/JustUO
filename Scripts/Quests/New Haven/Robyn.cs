...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        raised your Lucznictwo skill to 50. Well met, friend. Imagine yourself in a distant grove of trees, You raise your bow, 
        take slow, careful aim, and with the twitch of a finger, you impale your prey with a deadly arrow. You look like you 
        would make a excellent archer, but you will need practice. There is no better way to practice Lucznictwo than when you 
        ...
        Lucznictwo shop in town. You can also make your own arrows with the Bowcraft/Lukmistrzostwo skill. You will need fletcher's 
        tools, wood to turn into sharft's, and feathers to make arrows or bolts. Come back to me after you have achived the 
        rank of Apprentice Archer, and i will reward you with a fine Lucznictwo weapon. */ 
        ...
        /* I understand that Lucznictwo may not be for you. Feel free to visit me in the future if you change your mind. */
        ...
        public SwiftAsAnArrowQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Lucznictwo, 50, "Old Haven Training", 1078203, 1078204));
			
            // 1078203 You feel more steady and dexterous here. Your Lucznictwo skill is enhanced in this area.
            // 1078204 You feel less steady and dexterous here. Your Lucznictwo learning potential is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Lucznictwo.Base < 50;
        }
    ...
    public class Robyn : MondainQuester
    {
        ...
        { 
            ...
            this.SetSkill(SkillName.Lukmistrzostwo, 120.0, 120.0);
            this.SetSkill(SkillName.Leczenie, 120.0, 120.0);
            this.SetSkill(SkillName.Taktyka, 120.0, 120.0);
            this.SetSkill(SkillName.Lucznictwo, 120.0, 120.0);
            this.SetSkill(SkillName.Logistyka, 120.0, 120.0);
        }
        ...
        {
            this.Say(1078202); // Lucznictwo requires a steady aim and dexterous fingers.
        }
