...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        smelt the ore into ingots, until you have raised your Gornictwo skill to 50. You may find a packhorse useful for 
        ...
        public TheDeluciansLostMineQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.Gornictwo, 50, "Haven Mountains", 1077751, 1077752));
			
            // 1077751 You can almost smell the ore in the rocks here! Your ability to improve your Gornictwo skill is enhanced in this area.
            // 1077752 So many rocks, so little ore… Your potential to increase your Gornictwo skill is no longer enhanced.
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.Gornictwo.Base < 50;
        }
