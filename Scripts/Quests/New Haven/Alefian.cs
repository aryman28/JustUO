...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        the arcane art of Magia, I suggest learning the complementary skill known as Resisting Spells. While the 
        ...
        time. It does not lessen damage from spells such as Energy Bolt or Flamestrike.<BR><BR>The Magia spells that 
        can be resisted are Clumsy, Curse, Feeblemind, Mana Drain, Mana Vampire, Paralyze, Paralyze Field, Poison, 
        Poison Field, and Weaken.<BR><BR>The Nekromancja spells that can be resisted are Blood Oath, Corpse Skin, Mind 
        ...
        /* You have successfully begun your journey in becoming a true master of Magia. On behalf of the New Haven Mage 
        ...
        public DefyingTheArcaneQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.ObronaPrzedMagia, 50, "Old Haven Training", 1077494, 1077588));
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.ObronaPrzedMagia.Base < 50;
        }
