...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        there. You can also cast Nekromancja spells as well to raise Spirit Speak. Do these activities until you have raised your 
        ...
        of your Nekromancja spells. The channeling powers of a Medium are quite useful when practicing the dark magic of Nekromancja.
        ...
        cast Nekromancja spells as well to raise Spirit Speak.<br><br>Come back to me once you feel that you are worthy of the 
        ...
        reagents. You will need these if you wish to also pursue the dark magic of Nekromancja. Good journey to you. */
        ...
        public ChannelingTheSupernaturalQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.MowaDuchow, 50, "Old Haven Training", 1078045, 1078046));
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.MowaDuchow.Base < 50;
        }
