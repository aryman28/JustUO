...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        public CrushingBonesAndTakingNamesQuest()
            : base()
        { 
            this.AddObjective(new ApprenticeObjective(SkillName.WalkaObuchami, 50, "Old Haven Training", 1078063, 1078064));
        ...
        public override bool CanOffer()
        {
            ...
            if (pm.AcceleratedStart > DateTime.UtcNow)
            {
                ...
                return this.Owner.Skills.WalkaObuchami.Base < 50;
        }
    ...
    public class Churchill : MondainQuester
    {
        ...
        { 
            ...
            this.SetSkill(SkillName.WalkaObuchami, 120.0, 120.0);
