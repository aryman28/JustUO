...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        have raised your Anatomia skill to 50.<br><center>------</center><br>Hail and well met. You must be here to 
        improve your knowledge of Anatomia. Well, you've come to the right place because I can teach you what you need 
        ...
        science of Anatomia. Head out to Old Haven and practice combat and healing yourself or other adventurers. */
        ...
        your knowledge of Anatomia, but I know you'll get there someday. Just keep at it.<br><br>In the meantime, here's a 
        ...
        { 
            ...
            // 1077686 You feel very willing to learn more about the body. Your ability to hone your Anatomia skill is enhanced in this area.
            // 1077687 You lose your ambition to learn about the body. Your Anatomia skill learning potential is no longer enhanced.
        ...
        { 
            this.Owner.SendLocalizedMessage(1077691, null, 0x23); // You have achieved the rank of Apprentice Healer (for Anatomia). Return to Andreas Vesalius in New Haven as soon as you can to claim your reward.
    ...
    public class AndreasVesalius : MondainQuester
    {
        ...
        public AndreasVesalius()
            : base("Andreas Vesalius", "The Anatomia Instructor")
        { 
